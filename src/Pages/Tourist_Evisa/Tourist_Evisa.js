...
import "./Tourist_Evisa.css";
import FormEvisa from "../../Components/FormEvisa/FormEvisa";

function Tourist_Evisa() {
  return (
    <div>
      {" "}
      <div className="Moreinfo-container">
        <div className="Moreinfo-left-flex">
          <h3 className="Country-header-content">Tourist E-Visa</h3>
        ...
        <FormEvisa visaType={"Tourist E-Visa"} />
      </div>
