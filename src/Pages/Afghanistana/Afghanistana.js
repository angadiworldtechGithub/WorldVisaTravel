    ...
    <div className="Country-container">
      <div className="Country-content">
        ...
        <p className="Country-passage">
          {" "}
          A Tourist visa allows Travellers to vizit a foreign Country for
          Leisur, Sightseeing ,and recreational purpose, typically for a limited
          duration
        </p>
