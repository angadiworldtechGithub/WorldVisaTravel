...
import CongoVisa_1 from "../../../legalizationpdf/CongoVisa_1.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={CongoVisa_1}>Download Visa Application</a>,
...
const datatable1 = [
  ["Regular/Rush","Single/Multiple","$205.00", "2-4 Business Days", "Up to 30 days", "	3 Months"]
];

const datatable2 = [
  ["Regular","$90.00", "3-4 Business Days"],
...
export default BusinessNonUsCongo;
