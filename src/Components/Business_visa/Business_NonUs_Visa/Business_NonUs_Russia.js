...

    {
      ...
      column2: {
        content: [
          ...
          "Only applicable in certain countries. Please call for more information.          ",
...
<a target='_blank' href={'https://visa.kdmid.ru/PetitionChoice.aspx'}>Online Application Form</a>,
...
const datatable1 = [
  ['Regular','Single/ Double/ Multiple', '$93.00', '7-9 Business Days' ,'Up to 90/ 90/ 365 days', '-'],
  ['Rush','Single/ Double/ Multiple', '$173.00', '3-5 Business Days' ,'Up to 90/ 90/ 365 days', '-'],
  ['Emergency','Single/ Double/ Multiple', '$238.00', '1-2 Business Days' ,'Up to 90/ 90/ 365 days', '-'],
...
const datatable4 = [
  ['Regular','Single/ Double/ Multiple', '$133.00/ $187.00/ $313.00', '7-9 Business Days' ,'Up to 90/ 90/ 365 days', '-'],
  ['Rush','Single/ Double/ Multiple', '$253.00/ $361.00/ $613.00', '3-5 Business Days' ,'Up to 90/ 90/ 365 days', '-'],
  ['Emergency','Single/ Double/ Multiple', '$313.00/ $421.00/ $673.00', '1-2 Business Days' ,'Up to 90/ 90/ 365 days', '-'],
...
function Russia() {
  return (
   ...
   <div>
    ...
    <div className="req-table-container">
    <center><h3 className='costing-Header'>CONSULAR FEES (EU NATIONALITIES)</h3></center>
