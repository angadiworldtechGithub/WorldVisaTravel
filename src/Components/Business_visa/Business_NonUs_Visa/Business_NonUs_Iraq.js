...
import IraqVisa from "../../../legalizationpdf/IraqVisa.pdf";
...
const tableData = [
 ...
 
  {
    ...
    column2: {
      content: ["Visa Authorization Number from the government agency."],
    },
  },
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={IraqVisa}>Download Application Form</a>,
         " Three completed Visa Applications, MUST be signed."
       ],
    },
  },
...
const datatable1 = [
  ["Single/Multiple","$45.00/$105.00", "-", "Up to 30 days", "3 Months"],
];
...
export default BusinessNonUsIraq;
