...
import EritreaVisa from "../../../legalizationpdf/EritreaVisa.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={EritreaVisa}>Download Application Form</a>,
...
const datatable1 = [
  ["Single/Multiple","$75.00/$115.00", "10-15 Business Days", "Up to 30 days", "	3 Months/6 Months"],
  ["Single/Multiple","$205.00/$305.00", "10-15 Business Days", "Up to 30 days", "	6 Months/1 Year"]
];
...
export default BusinessNonUsEritrea;
