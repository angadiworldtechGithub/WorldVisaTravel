...
import BelarusVisa from "../../../legalizationpdf/BelarusVisa.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={BelarusVisa}>Download Appication Form</a>,
...
export default BusinessNonUsBelarus;
