...
import CentralAfricanRepublicVisaApp from "../../../legalizationpdf/CentralAfricanRepublicVisaApp.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={CentralAfricanRepublicVisaApp}>Download Application Form</a>,
...
function BusinessNonUsCentralAfricanRepublic() {
  return (
    <div>
      <div>
...
export default BusinessNonUsCentralAfricanRepublic;
