...
import Bangladesh_Application_Printable  from "../../../legalizationpdf/Bangladesh_Application_Printable.pdf";
...
const tableData = [
  ...
  
  {
    ...
    column2: {
      content: ["	A letter of invitation from host organization in Bangladesh is required."],
    },
  },
    ...
    column1: "Application Form",
      column2: {
        content: [
          ...
          <a download={true} target='_blank' href={Bangladesh_Application_Printable}>Printable Application Form</a>,   ],
      },
  },
...
const datatable1 = [
  ["Regular","Single/Multiple","*Varies based on Nationality", "10-12 Business Days", " Up to 30-90 days", "	6 Months - 5 Years"],
];
...
function BusinessNonUsBangladesh() {
  return (
    <div>
      <div>
...
export default BusinessNonUsBangladesh;
