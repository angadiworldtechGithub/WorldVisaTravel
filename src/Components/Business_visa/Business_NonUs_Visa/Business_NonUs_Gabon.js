...
import GabonVisa from "../../../legalizationpdf/GabonVisa.pdf";
...
const tableData = [
 ...
 
  {
    ...
    column2: {
      content: ["	A letter of invitation from host organization in Gabon."],
    },
  },
  {
    id: 7,
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={GabonVisa}>Download Application Form</a>,
...
const datatable1 = [
  ["Regular/Rush","Multiple","$205.00", "1-5 Business Days", "Determined upon arrival", "1-5 Years"],
];
    ...
    <div>
      ...
      <div className="req-table-container">
        ...
        <div className="Detailsdata_descripition">
          ...
          <h6>* Regular processing applications can only be submitted on Thursday and Friday.</h6>
          <h6>** Rush processing applications can only be submitted on Monday to Friday.</h6>
...
export default BusinessNonUsGabon;
