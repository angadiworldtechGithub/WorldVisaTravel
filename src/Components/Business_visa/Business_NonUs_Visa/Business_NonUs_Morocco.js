...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: ["	A letter of invitation from host organization in Morocco."],
    },
  },
  {
    id: 6,
...
const datatable1 = [
  ["Single/Double","$27.60/$8.90", "4-5Business Days", "Up to 90 days"],
];
...
export default BusinessNonUsMorocco;
