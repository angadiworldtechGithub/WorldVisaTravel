...
import MongoliaVisa from "../../../legalizationpdf/MongoliaVisa.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: ["	A letter of invitation from host organization in Mongolia."],
    },
  },
  {
    id: 6,
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={MongoliaVisa}>Download Application Form</a>,
...
const datatable1 = [
  ["Single/Double/Multiple/Multiple","$50.00/$65.00/$70.00/$200.00", "5 Business Days", "Up to 30 days", "3 Months/3 Months/6 Months/1 Year"],
];
const datatable2 = [
...
function BusinessNonUsMongolia() {
  return (
    <div>
      <div>
      ...
      <div className="req-table-container">
        ...
        <div className="Detailsdata_descripition">
          ...
          <center>
          <h3 className="costing-Header">CONSULAR FEES(UK AND CANADIAN NATIONALITIES)</h3>
        </center>
        <table className="costing-responsive-table">
          <thead>
            <tr>
...
export default BusinessNonUsMongolia;
