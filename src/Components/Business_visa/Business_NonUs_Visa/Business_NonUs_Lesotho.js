...
import LesothoVisa from "../../../legalizationpdf/LesothoVisa.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: ["A Police Clearance Letter from your district. There is a clearance fee of $70.00."],
    },
  },
  {
    id: 6,
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={LesothoVisa}>Download Application Form</a>,
...
const datatable1 = [
  ["Single","$35.00", "2 Business Days", "Up to 30 days", "3 Months"],
];

const datatable2 = [
  ["$90.00", "2 Business Days"],
...
export default BusinessNonUsLesotho;
