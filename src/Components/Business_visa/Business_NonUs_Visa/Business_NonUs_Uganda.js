...
import UgandaWhiteGlove from "../../../legalizationpdf/UgandaWhiteGlove.pdf"
  ...
  const tableData = [
    ...
    },
    {
      ...
      column2: {
        content: [
          "Upload one passport type photo as part of the online Visa application.          ",   
        ...
        "The photo should be a 2×2 recently taken photo, acceptable file types are – JPEG, BMP and GIF."
        ],
      },
    },
...

    {
      ...
      column2: {
        content: [
          "WVT can help you complete the Uganda Visa Online Application through our White Glove Service (ONLY $50.00).          ",
          
          <a download={true} target='_blank' href={UgandaWhiteGlove}>Uganda White Glove Form  </a>,
          <a target='_blank' href="https://visas.immigration.go.ug/">Online Application Form</a>,
          "One confirmation page, MUST be printed.          ",
          "Select “Ordinary” when choosing your Passport type.          ",
          "Do NOT mail your documents to the Uganda Embassy.          ",
          "Please send all required documents to WVT.          ",
          "This is to prevent any delays for your Visa application.          "
        ],
      },
    },
...
const datatable1 = [
    ['Regular','Multiple','$105.00','5-7 Business Days','Up to 180 days	','6 Months  '],
    ['Rush','Multiple','$205.00','3-4 Business Days','Up to 180 days	','6 Months  '],
];
