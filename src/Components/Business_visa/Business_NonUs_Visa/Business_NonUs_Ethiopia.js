...
import EthiopiaVisa from "../../../legalizationpdf/EthiopiaVisa.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={EthiopiaVisa}>Download Application Form</a>,
...
const datatable1 = [
  ["Single","$35.00", "7-10 Business Days", "Validity of Visa", "	30 days from Issue"],
  ["Multiple","$45.00/$65.00", "7-10 Business Days", "	Up to 30 days", "	3 Months/6 Months"]
];
...
function BusinessNonUsEthiopia() {
  return (
    <div>
      <div>
...
export default BusinessNonUsEthiopia;
