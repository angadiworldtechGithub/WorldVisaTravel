...
import BFA_Visa from "../../../legalizationpdf/BFA_Visa.pdf";
const tableData = [
  {
    id: 1,
    column1: "Passport",
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={BFA_Visa}>Download Application Form</a>,
...
function BusinessNonUsBurkinFaso() {
  return (
    <div>
      <div>
...
export default BusinessNonUsBurkinFaso;
