...
import AlgeriaVisa from "../../../legalizationpdf/AlgeriaVisa.pdf";
...
const tableData = [
...

  {
    ...
    column2: {
      content: ["A business letter from the company is required.",
      <a href="/Business_Sample" >Business Sample Download</a>
    ]
    },
  },

  {
    ...
    column2: {
      content: ["	A letter of invitation from host company in Algeria is required."],
    },
  },
  {
    id: 6,
  ...
  },
  {
    ...
    column1: "Application Form",
      column2: {
        content: [
          <a download={true} target='_blank' href={AlgeriaVisa}>Download Visa Application</a>,
          "Two completed Visa Applications, MUST be typed and signed."
        ],
      },
  },
...
const datatable1 = [
  ["Regular","Single/Multiple", "$170.00", "5-10 Business Days", "Per Application", "Per Application"],
  ["Rush","Single/Multiple", "$170.00", "2-4 Business Days", "Per Application", "Per Application"],
];

const datatable2 = [
  ["Regular","$90.00", "5-10 Business Days"],
  ["Rush","$125.00", "2-4 Business Days"]
...
export default BusinessNonUsAlgeria;
