...
import DRCVisa1 from "../../../legalizationpdf/DRCVisa1.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={DRCVisa1}>Download Application Form</a>,
...
const datatable1 = [
  ["Regular","Single","$105.00/$140.00/$405.00", "7-10 Business Days", "Up to 30/60/180 days", "	1 Month/2 Months/6 Months"],
["Regular","Multiple","$125.00/$155.00/$165.00/$455.00", "7-10 Business Days", "Up to 30/60/90/180 days", "	1 Month/2 Months/3 Months/6 Months"]
];

const datatable2 = [
  ["Regular","$90.00", "7-10 Business Days"],
  ["Rush (if possible)","$140.00", "4-5 Business Days"],
...
function BusinessNonUsCongoDemocraticRepublic() {
  return (
    <div>
      <div>
...
export default BusinessNonUsCongoDemocraticRepublic;
