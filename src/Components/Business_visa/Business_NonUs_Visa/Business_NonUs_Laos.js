...
import LaosVisa from "../../../legalizationpdf/LaosVisa.pdf";
const tableData = [
  {
    id: 1,
    column1: "Passport",
 ...
 
  {
    ...
    column1: "Photo",
    column2: {
      content: ["Three passport-type photographs. ", <a href='https://travel.state.gov/content/travel/en/passports/how-apply/photos.html' target="_blank" >Quality Requirements for Passport Book & Passport Card Photographs</a>
    ],
  },
  },
  {
    ...
    column2: {
      content: ["A letter of approval from the Immigration Department in Vientiane, to be sent to the Embassy of Laos in Washington DC."],
    },
  },
  {
    id: 4,
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={LaosVisa}>Download Application Form</a>,
...
export default BusinessNonUsLaos;
