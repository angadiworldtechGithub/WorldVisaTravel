...
import FijiVisa from "../../../legalizationpdf/FijiVisa.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: ["	A Police Clearance Letter from your district."],
    },
  },
  {
    id: 6,
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={FijiVisa}>Download Application Form</a>,
...
const datatable1 = [
  ["Single/Multiple","$71.00/$126.00", "14 Business Days", "Up to 30 days", "	3 Months"],
];
...
export default BusinessNonUsFiji;
