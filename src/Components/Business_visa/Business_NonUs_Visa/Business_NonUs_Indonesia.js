...
const tableData = [
 ...
 
  {
    ...
    column2: {
      content: ["A letter of invitation from host organization in Indonesia."],
    },
  },
  {
    id: 6,
    ...
    column2: {
      content: ["To enter Maluku, Poso, and Irian Jaya, travelers have to obtain a permit or authorization from the Department of Foreign Affairs in Jakarta."],
    },
  },
  ...
  },
  {
    ...
    column2: {
      content: [
        <a href="https://consular.embassyofindonesia.org/visa/dsv/getstarted.html" target="_blank">Online Application Form</a>,
...
function BusinessNonUsIndonesia() {
  return (
    <div>
      <div>
...
export default BusinessNonUsIndonesia;
