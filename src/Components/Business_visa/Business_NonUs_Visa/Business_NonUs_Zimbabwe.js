...
import ZimbabweVisa from "../../../legalizationpdf/ZimbabweVisa.pdf"
  ...
  const tableData = [
    ...
    
    {
        ...
        column2: {
          content: [
            "A letter of invitation from the host organization in Yemen.            ",
          ],
        },
      },
...
const datatable1 = [
    ['	Single','$65.00','Up to 90 days	','	6 Months','	3 Weeks'],
    ['Double','$80.00','	Up to 90 days	','	6 Months','	3 Weeks'],
...
const datatable4 = [
    ['Canada','	Single','$70.00','3 Weeks	','Up to 90 days','	6 Months'],
    ['Ireland','	Single','$80.00','3 Weeks	','Up to 90 days','	6 Months'],
    ['United Kingdom','	Double','$100.00','3 Weeks	','Up to 90 days','	6 Months'],
...
function Zimbabwe() {
  return (
   ...
   <div>
    ...
    <h6>These are the fees charged by the Foreign Government for issuing a Visa. Fees are per person per visa.</h6>
      ...
      <div className='Detailsdata_descripition'>
       <h6>Note:The fees above include a $5.00 check writing fee.</h6>
      ...
      <center><h3 className='costing-Header'>CONSULAR FEES(CANADA, IRELAND, UK NATIONALITIES)</h3></center>
      <table className="costing-responsive-table">
        <thead>
          <tr>
          <th>Country</th>
     ...
     <h6>Fees charged by World Visa Travel in obtaining your Visa.</h6>
      <table className="costing-responsive-table">
        <thead>
          <tr>
