...
import MyanmarOfficialDiplomatic from "../../../legalizationpdf/MyanmarOfficialDiplomatic.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: ["	A letter of invitation from host organization in Myanmar."],
    },
  },
  {
    id: 6,
    column1: "Multiple Entries Visa",
    column2: {
      content: ["	First time applicants can only apply for Single Entry Visa."],
    },
  },
  {
    id: 7,
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={MyanmarOfficialDiplomatic}>Download Application Form</a>,
...
const datatable1 = [
  ["Single/Multiple/Multiple/Multiple","$55.00/$205.00/$405.00/$605.00", "7-10 Business Days", "Up to 70 days", "3 Months/3 Months/6 Months/1 Year"],
];
...
export default BusinessNonUsMyanmar;
