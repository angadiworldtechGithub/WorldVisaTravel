...
const datatable1 = [
  ["Regular","Multiple","$186.82/$277.73", "7-10 Business Days", "Up to 30 Days/180 Days", "	6 Months"],
  ["Rush","Multiple","$277.73/$368.64", "2-4 Business Days", "Up to 30 Days/180 Days", "	1 Year"]
];
...
function BusinessNonUsCameroon() {
  return (
    <div>
      <div>
      ...
      <div className="req-table-container">
        ...
        <div className="Detailsdata_descripition">
          ...
          <h6><strong>The Embassy of Cameroon will not allow submitted Passport/Application to be cancelled or withdrawn until the process is completed.</strong></h6>
        </div>
...
export default BusinessNonUsCameroon;
