...
import MalawiVisa from "../../../legalizationpdf/MalawiVisa.pdf";
...
const tableData = [
  ...
  {
    id: 5,
    column1: "Residential Status",
    column2: {
      content: ["	A copy of the host’s residential status in Malawi (e.g. Permit or Malawi Passport if Malawian)."],
    },
  },
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={MalawiVisa}>Download Application Form</a>,
        "Two completed Visa Application, MUST be signed in BLUE INK.",
      ],
    },
  },
...
const datatable1 = [
  ["Transit/Single/Multiple/Multiple","$75.00/$105.00/$225.00/$305.00", "5 Business Days", "Up to 30 days", "3 Months/6 Months/1 Year"],
];

const datatable2 = [
  ["Regular","$90.00", "5 Business Days"],
  ["Rush","$140.00", "2 Business Days"],
...
export default BusinessNonUsMalawi;
