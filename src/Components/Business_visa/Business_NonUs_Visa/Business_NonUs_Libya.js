...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: ["	Government authorization or approval document to enter Libya (usually supplied by a Libyan tour operator)."],
    },
  },
  {
    id: 6,
...
const datatable1 = [
  ["Single/Single/Multiple","$155.00/$205.00/$355.00", "3 Business Days", "Up to 30 days", "3 Months"],
];

const datatable2 = [
  ["$90.00", "3 Business Days"],
...
export default BusinessNonUsLibya;
