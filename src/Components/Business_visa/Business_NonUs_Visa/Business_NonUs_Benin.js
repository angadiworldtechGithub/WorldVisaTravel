...
import BENIN_Visa_Application from "../../../legalizationpdf/BENIN_Visa_Application.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column1: "Application Form",
      column2: {
        content: [
          <a download={true} target='_blank' href={BENIN_Visa_Application}>Download Application Form</a>,
...
const datatable1 = [
  ["Regular","Single/Double/Multiple","$105.00", "5-6 Business Days", "	Up to 90 days", "	3 Months"],
  ["Rush","Single/Double/Multiple","$105.00", "1-2 Business Days", "	Up to 90 days", "	3 Months"]
];
...
export default BusinessNonUsBenin;
