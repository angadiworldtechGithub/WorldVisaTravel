...
import GambiaVisaApp from "../../../legalizationpdf/GambiaVisaApp.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={GambiaVisaApp}>Download Application Form</a>,
...
export default BusinessNonUsGambia;
