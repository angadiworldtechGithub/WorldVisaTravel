...
import HondurasVisa from "../../../legalizationpdf/HondurasVisa.pdf";
const tableData = [
  {
    id: 1,
    column1: "Passport",
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={HondurasVisa}>Download Visa Application</a>,
...
const datatable1 = [
  ["Single","$5.00", "4-5 Business Days", "Up to 90 days", "3 Months"],
];
...
function BusinessNonUsHonduras() {
  return (
    <div>
      <div>
...
export default BusinessNonUsHonduras;
