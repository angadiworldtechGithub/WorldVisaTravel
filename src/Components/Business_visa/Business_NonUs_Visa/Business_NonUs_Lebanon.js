...
import LebanonVisa from "../../../legalizationpdf/LebanonVisa.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={LebanonVisa}>Download Application Form</a>,
...
const datatable1 = [
  ["Single/Multiple","$45.00/75.00", "3-4 Business Days", "Up to 30 days", "1 Month/3-6 Months"],
];

const datatable2 = [
  ["$90.00", "3-4 Business Days"],
...
export default BusinessNonUsLebanon;
