...
import SudanVisa from "../../../legalizationpdf/SudanVisa.pdf"
  ...
  const tableData = [
...

    {
        ...
        column2: {
          content: [
            "A Visa Approval from the Sudan Ministry of Foreign Affairs.            ",
      ...
      {
        id: 6,
        column1: "Humanitarian		",
        column2: {
          content: [
            "A copy of the Humanitarian Aid Commission Certificate (HAC).            ",
          ],
        },
      },

      {
        ...
        column2: {
          content: [
            "IA letter from your employer as a proof of employment.            ",
          ],
        },
      },
...
const datatable1 = [
  ['Single', '$159.00', '4-5 Business Days' ,'Up to 30 days', '3 Months'],

];

const datatable2 = [
  ['$90.00','4-6 Weeks'],
  ['$140.00','Less than 4 Weeks'],
