...
import GhanaRegularVisa from "../../../legalizationpdf/GhanaRegularVisa.pdf";
import GhanaAppsRush from "../../../legalizationpdf/GhanaAppsRush.pdf";
...
const tableData = [
...

  {
    ...
    column2: {
      content: ["	A letter of invitation from host organization in Ghana."],
    },
  },
  {
    id: 6,
    ...
    column2: {
      content: ["	International Certificate of Vaccination for Yellow Fever."],
    },
  },
  {
    id: 7,
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={GhanaRegularVisa}>Download Regular Application Form</a>,
        "One completed Visa Application, MUST be signed.",
        "Application can be filled electronically or with Black INK only, in BLOCK / CAPITAL letters.",
        <a download={true} target='_blank' href={GhanaAppsRush}>Download Rush Application Form</a>,
...
const datatable1 = [
  ["Regular","Single/Multiple","$65.00/$105.00", "15-20 Business Days", "Up to 30 days", "	3 Months/1-3 Years"],
  ["Rush","Single/Multiple","$105.00/$205.00", "7 Business Days", "Up to 30 days", "	3 Months/1-3 Years"],
];

const datatable2 = [
  ["Regular","$120.00", "15-20 Business Days"],
  ["Rush","$170.00", "7 Business Days"]
  ...
  return (
    <div>
      ...
      <div className="req-table-container">
        ...
        <div className="Detailsdata_descripition">
         <h6>*Special Embassy Mail-In Fee Included. Please call for more details.</h6>
        </div>
...
export default BusinessNonUsGhana;
