...

    {
      ...
      column2: {
        content: [
          ...
          <a download={true} target='_blank' href={SaudiDeclaration}>Download Declaration Form</a>,
          "One completed Declaration Form, MUST be signed.          ",
          <a download={true} target='_blank' href={SaudiEnjaz}>Download Saudi Enjaz Questionnaire</a>,
...
const datatable1 = [
  ['Regular/ Rush','Single/ Multiple', '$99.50/ $180.50', '1-3/ 4-5 Business Days' ,'Up to 30-90 days', '3 Months - 5 Years'],
