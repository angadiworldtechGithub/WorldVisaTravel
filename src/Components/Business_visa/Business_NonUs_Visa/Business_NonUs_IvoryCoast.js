...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={Cote_dIvoire_Visa_App}>Download Application Form</a>,
...
function BusinessNonUsIvoryCoast() {
  return (
    <div>
      <div>
...
export default BusinessNonUsIvoryCoast;
