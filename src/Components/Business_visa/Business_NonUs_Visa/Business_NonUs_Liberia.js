...
import Liberia_Application from "../../../legalizationpdf/Liberia_Application.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column1: "Minors",
    column2: {
      content: ["A notarized letter of consent from the parents or guardian as well as a copy of the birth certificate of the minor is required."],
    },
  },
  {
    id: 6,
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={Liberia_Application}>Download Application Form</a>,
        "Two completed Visa Applications, MUST be signed in BLUE INK.",
      ],
    },
  },
...
const datatable1 = [
  ["Regular","Single/Multiple","$75.00/$155.00/$255.00", "7-10 Business Days", "Up to 30 days", "3 Months/1 Year/2 Years"],
  ["Rush","Single/Multiple","$125.00/$205.00/$305.00", "1-2 Business Days", "Up to 30 days", "3 Months/1 Year/2 Years"],
  ["Same Day","Single/Multiple","$150.00/$230.00/$330.00", "Same Day", "Up to 30 days", "3 Months"],
];

const datatable2 = [
  ["Regular","$90.00", "7-10 Business Days"],
  ["Rush","$140.00", "1-2 Business Days"],
  ["Emergency","$190.00", "Same Day"],
...
export default BusinessNonUsLiberia;
