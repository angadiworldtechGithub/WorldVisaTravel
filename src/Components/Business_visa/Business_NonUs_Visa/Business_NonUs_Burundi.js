...
import BurundiVisa from "../../../legalizationpdf/BurundiVisa.pdf";
const tableData = [
  {
    id: 1,
    column1: "Passport",
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={BurundiVisa}>Download Application Form</a>,
...
export default BusinessNonUsBurundi;
