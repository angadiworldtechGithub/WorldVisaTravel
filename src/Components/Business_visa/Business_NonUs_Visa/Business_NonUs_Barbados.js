...
import BarbadosVisa from "../../../legalizationpdf/BarbadosVisa.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: ["Evidence of international medical insurance."],
    },
  },
  {
    id: 5,
    ...
    column2: {
      content: ["	An official letter of invitation from host organization in Belarus."],
    },
  },
 
  {
    id: 6,
    column1: "Multiple Entry Visa",
    column2: {
      content: ["Confirmation from the Ministry of Foreign Affairs of Belarus."],
    },
  },
  {
    id: 7,
    column1: "Former USSR/Belarusian Citizens",
    column2: {
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={BarbadosVisa}>Download Visa Application</a>,
...

  {
    ...
    column2: {
      content: [
        "Please complete WVT Work Order Form. Download here", "Please complete WVT Work Order Form. ",
...
const datatable1 = [
  ["Single/Multiple","$105.00/$205.00", "5-10 Business Days*", "	Up to 30 days", "	3 Months"],
 
];

const datatable2 = [
  ["Regular","$90.00", "5-6 Business Days"],
  ["Rush","$120.00", "1-2 Business Days"]
...
function BusinessNonUsBarbados() {
  return (
    <div>
      <div>
      ...
      <div className="req-table-container">
        ...
        <div className="Detailsdata_descripition">
          ...
          <h6>* Certain Nationalities can experience longer processing time.</h6>
        </div>
...
export default BusinessNonUsBarbados;
