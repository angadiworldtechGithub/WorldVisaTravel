...
import Egypt_Visa_Application from "../../../legalizationpdf/Egypt_Visa_Application.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={Egypt_Visa_Application}>Download Application Form</a>,
...
const datatable1 = [
  ["Most Nationalities","Single/Multiple","$45.00/$60.00", "10 Business Days", "Up to 30 days", "	3 Months"],
  ["Canadian","Single/Multiple","$55.00/$75.00", "10 Business Days", "Up to 30 days", "	3 Months"],
  ["UK","Single/Multiple","$85.00/$150.00", "10 Business Days", "Up to 30 days", "	3 Months"],
];
...
export default BusinessNonUsEgypt;
