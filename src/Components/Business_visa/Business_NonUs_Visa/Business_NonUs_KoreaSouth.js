...
import SouthKoreaVisaApp from "../../../legalizationpdf/SouthKoreaVisaApp.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={SouthKoreaVisaApp}>Download Application Form</a>,
...
const datatable1 = [
  ["Single/Multiple","$45.00/$65.00/$95.00", "4 Business Days", "Up to /more than 90 days", "3 Months"],
];
...
function BusinessNonUsKoreaSouth() {
  return (
    <div>
      <div>
...
export default BusinessNonUsKoreaSouth;
