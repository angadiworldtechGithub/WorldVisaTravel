...
import MalaysiaVisa from "../../../legalizationpdf/MalaysiaVisa.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: ["A letter of invitation from the host organization in Malaysia."],
    },
  },
  {
    id: 6,
    ...
    column2: {
      content: ["A letter from your employer as a proof of employment."],
    },
  },
  {
    id: 7,
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={MalaysiaVisa}>Download Application Form</a>,
...
const datatable1 = [
  ["Single/Multiple","$19.00/$32.00", "3-10 Business Days", "-", "-"],
];

const datatable2 = [
  ["$90.00", "3-10 Business Days"],
...
function BusinessNonUsMalaysia() {
  return (
    <div>
      <div>
...
export default BusinessNonUsMalaysia;
