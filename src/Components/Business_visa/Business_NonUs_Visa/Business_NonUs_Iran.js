...
import IranVisa from "../../../legalizationpdf/IranVisa.pdf";
...
const tableData = [
 ...
 
  {
    ...
    column1: "Photo",
    column2: {
      content: ["One recent professional passport-type photograph. Do NOT staple or glue the photo to the application.","Photos of Muslim age 9 and up must be Islamic cover head (hejab), and Islamic dress code.Write your name lightly at the back of the photo and use paperclip with the application.", <a href='https://travel.state.gov/content/travel/en/passports/how-apply/photos.html' target="_blank" >Quality Requirements for Passport Book & Passport Card Photographs</a>
    ],
  },
  },
  {
  ...
  {
    id: 5,
    column1: "Visa Authorization Number",
    column2: {
      content: ["Visa Authorization Number from the tour company."],
    },
  },
  {
    id: 6,
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={IranVisa}>Download Visa Application</a>,
...
const datatable1 = [
  ["Regular","Single","$125.00/$183.00", "5-7 Business Days", "-", "-"],
];
...
export default BusinessNonUsIran;
