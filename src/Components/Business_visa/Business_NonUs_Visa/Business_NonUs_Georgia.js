...
import GeorgiaVisa from "../../../legalizationpdf/GeorgiaVisa.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: ["A letter of invitation from host organization in Georgia."],
    },
  },
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={GeorgiaVisa}>Download Application Form</a>,
...
const datatable1 = [
  ["Single","$15.00/$35.00", "5-15 Business Days", "30 days/90 days", "	3 Months"],
  ["Double","$20.00/$50.00", "5-15 Business Days", "30 days/90 days", "	3 Months"],
  ["Multiple","$105.00", "45 Business Days", "1 Year", "	1 Year"]
];

const datatable2 = [
  ["$90.00", "5-15 Business Days"],
...
export default BusinessNonUsGeorgia;
