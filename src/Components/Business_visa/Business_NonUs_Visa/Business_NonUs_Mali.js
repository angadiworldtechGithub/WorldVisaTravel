...
import MaliVisa from "../../../legalizationpdf/MaliVisa.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={MaliVisa}>Download Application Form</a>,
...
const datatable1 = [
  ["Regular","Single/Multiple/Multiple/Multiple","$85.00/$115.00/$205.00/$375.00", "5-7 Business Days", "Up to 30 days", "3 Months/3 Months/6 Months/1 Year"],
  ["Rush","Single/Multiple/Multiple/Multiple","$105.00/$135.00/$225.00/$395.00", "2-3 Business Days", "Up to 30 days", "3 Months/3 Months/6 Months/1 Year"],
  ["Emergency","Single/Multiple/Multiple/Multiple","$135.00/$155.00/$255.00/$325.00", "Same/Next days", "Up to 30 days", "3 Months/3 Months/6 Months/1 Year"]
...
export default BusinessNonUsMali;
