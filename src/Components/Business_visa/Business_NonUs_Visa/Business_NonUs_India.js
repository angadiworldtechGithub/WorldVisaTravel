...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: ["	A business letter (sample) from the company is required."," Download Business Letter","One completed Form, MUST be signed."],
    },
  },
 
  {
    ...
    column2: {
      content: ["Sponsor Invitation Letter for business travelers: Download Sponsor Invitation Letter",
...
export default BusinessNonUsIndia;
