...
import MozambiqueVisa from "../../../legalizationpdf/MozambiqueVisa.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={MozambiqueVisa}>Download Application Form</a>,
...
const datatable1 = [
  ["Regular","Single/Multiple","$165.00/$185.00", "10 Business Days", "Up to 30 days", "2 Months/3 Months"],
    ["Rush","Single/Multiple","$225.00/$225.00", "2-4 Business Days", "Up to 30 days", "2 Months/3 Months"],];

const datatable2 = [
  ["Regular","$90.00", "10 Business Days"],
...
function BusinessNonUsMozambique() {
  return (
    <div>
      <div>
      ...
      <div className="req-table-container">
        ...
        <div className="Detailsdata_descripition">
         ...
         <h6>Mozambique Embassy is closed for public on Fridays, thus submissions/collections of Passports/Visas are not permitted.</h6>
...
export default BusinessNonUsMozambique;
