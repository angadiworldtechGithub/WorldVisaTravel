...
import TurkmenistanVisa from "../../../legalizationpdf/TurkmenistanVisa.pdf"
  ...
  const tableData = [
...

    {
        ...
        column2: {
          content: [
            "Letter of invitation on letterhead from a host company or organization in Turkmenistan to be visited, certified by            ",
            "the State Foreign Citizens Registration Service of Turkmenistan. The invitation is valid only for 3 months from the date it was confirmed.            ",
