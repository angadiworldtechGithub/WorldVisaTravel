...
import Afghanistan from "../../../legalizationpdf/Afghanistan.pdf"
  ...
  },
  {
    ...
    column2: {
      content: [
        ...
        <a download={true} target='_blank' href={Afghanistan}>Download Application Form</a>,
...
function BusinessUsAfghanistan() {
  return (
    <div>
      <div>
...
export default BusinessUsAfghanistan;