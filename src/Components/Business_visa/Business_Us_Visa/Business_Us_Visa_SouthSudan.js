...
import SouthSudanVisa from "../../../legalizationpdf/SouthSudanVisa.pdf"
  ...
  const tableData = [
...

    {
        ...
        column2: {
          content: [
            "A letter of invitation from host organization in South Sudan.         ",
          ],
        },
      },
    ...
    {
        id: 5,
        column1: "Former South Sudan Nationalities	",
        column2: {
          content: [
...

    {
      ...
      column2: {
        content: [
          <a download={true} target='_blank' href={SouthSudanVisa}>Download Application Form</a>,
...
const datatable1 = [
    ['Single', '$165.00', '5-10 Business Days	' ,'	Up to 30 days', '-  '],

];

const datatable2 = [
  ['$90.00','5-10 Business Days  '],
...
const datatable4 = [
    ['Single', '$50.00', '5-10 Business Days	' ,'	Up to 30 days', '-  '],
...
function SouthSudan() {
  return (
   ...
   <div>
    ...
    <div className="req-table-container">
    <center><h3 className='costing-Header'>CONSULAR FEES(US CITIZENS)</h3></center>
      ...
      <center><h3 className='costing-Header'>CONSULAR FEES(FORMER SOUTH SUDANESE NATIONALITIES)</h3></center>
      <table className="costing-responsive-table">
        <thead>
          <tr>
