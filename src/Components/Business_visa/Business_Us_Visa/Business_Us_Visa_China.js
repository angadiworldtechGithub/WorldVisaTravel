...
import ChinaVisa from "../../../legalizationpdf/ChinaVisa.pdf";
  ...
  const tableData = [
...

    {
        ...
        column2: {
          content: [
            "A letter of invitation from host organization in China is required       ",
          ],
        },
      },
...
<a target='_blank' href={'https://avas.mfa.gov.cn/qzyyCoCommonController.do?yyindex&locale=en_US'}>Appointment for Visa Application Submission (AVAS)
   ...
   <div>
    ...
    <center><h3 className='costing-Header'>CONSULAR FEES</h3></center>
     ...
     <center><h3 className='costing-Header'> WORLD VISA TRAVEL SERVICE FEES</h3></center>
      ...
      <div className='Detailsdata_descripition'>
       <h6>*Depends on availability. Please contact us for more information.</h6>
