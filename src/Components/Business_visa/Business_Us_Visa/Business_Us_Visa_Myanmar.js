...
import MyanmarBusinessApplication from "../../../legalizationpdf/MyanmarBusinessApplication.pdf"
  ...
  const tableData = [
...

    {
      ...
      },
      {
        ...
        column2: {
          content: [
            "First time applicants can only apply for Single Entry Visa.            ",
          ],
        },
      },
...

    {
      ...
      column2: {
        content: [
          <a download={true} target='_blank' href={MyanmarBusinessApplication}>Download Visa Application.</a>,
