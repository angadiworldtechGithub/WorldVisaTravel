...
import CameroonVisaApp_1 from "../../../legalizationpdf/CameroonVisaApp_1.pdf";
  ...
  const tableData = [
...

    {
        ...
        column2: {
          content: [
            "A letter of invitation from host organization in Cameroon.            ",
          ],
        },
      },
...
const datatable1 = [
  ['Regular','Multiple', '$186.00/ $277.00/ ', '7-10 Business Days' ,'Up to 30/180 days', '6 Months'],
  ['Rush','Multiple', '$277.00/ $368.64/ ', '2-4 Business Days' ,'Up to 30/180 days', '1 Year'],
