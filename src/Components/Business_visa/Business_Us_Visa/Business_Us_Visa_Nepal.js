...
import NepalVisaTourist from "../../../legalizationpdf/NepalVisaTourist.pdf"
  ...
  const tableData = [
...

    {
      ...
      column2: {
        content: [
          <a download={true} target='_blank' href={NepalVisaTourist}>Download Visa Application.</a>,
...
const datatable1 = [
    ['Multiple', '$30.00/ $45.00/ $105.00', '6-8 Business Days	' ,'	Up to 15 days/ 30 days/ 90 days', '6 Months    '],
