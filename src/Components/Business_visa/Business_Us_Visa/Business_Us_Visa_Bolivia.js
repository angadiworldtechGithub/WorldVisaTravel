  ...
  const tableData = [
...

    {
...

      {
        ...
        column2: {
          content: [
            "A Good Conduct Certificate from local Police Department.            ",
          ],
        },
      },
...
const datatable1 = [
  ['Regular','Single', '$90.00', '5-10 Business Days' ,'Up to 30 days', '3 Months'],
  ['Regular','Multiple', '$205.00', '1-2 Business Days' ,'Up to 30 days', '1 Year']
