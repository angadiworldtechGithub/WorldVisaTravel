...
import PakistanVisa from "../../../legalizationpdf/PakistanVisa.pdf"
import PakistanBusinessAdditional from "../../../legalizationpdf/PakistanBusinessAdditional.pdf"
  ...
  const tableData = [
...

    {
        ...
        column2: {
          content: [
            "A letter of invitation from host organization in Pakistan.            ",
          ],
        },
      },
...

    {
      ...
      column2: {
        content: [
          <a download={true} target='_blank' href={PakistanVisa}>Download Application Form</a>,
          'Four completed Visa Application, ALL MUST be signed.          ',
          <a download={true} target='_blank' href={PakistanBusinessAdditional}>Additional Application Form</a>,
          "In addition to filling out the main application form above, please fill out this additional form.          "
        ],
      },
    },
...
const datatable1 = [
    ['Single/Multiple', '$329.00', 'More than 4 Weeks		' ,'	Up to 30 days', '3 - Months to 1 Year    '],

];

const datatable2 = [
  ['$90.00','More than 4 Weeks  '],
