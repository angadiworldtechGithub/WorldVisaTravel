...
import IndiaReligious from "../../../legalizationpdf/IndiaReligious.pdf";
import IndiaJournalist from "../../../legalizationpdf/IndiaJournalist.pdf";
import IndiaBusiness from "../../../legalizationpdf/IndiaBusiness.pdf";
import IndiaSponsor from "../../../legalizationpdf/IndiaSponsor.pdf";
import IndiaMinors from "../../../legalizationpdf/IndiaMinors.pdf";
...
const tableData = [
 ...
 
  {
    ...
    column1: "Photo",
    column2: {
      content: ["Two passport-type photographs. ", <a href='https://travel.state.gov/content/travel/en/passports/how-apply/photos.html' target="_blank" >Quality Requirements for Passport Book & Passport Card Photographs</a>
    ],
  },
  },
  {
  ...
  },
  {
    ...
    column2: {
      content: ["A copy of your Driver’s License, Major Utility Bill (Water, Gas, Electric, etc.), or a copy of valid lease agreement."],
    },
  },
  {
    id: 5,
    ...
    column2: {
      ...
      <a download={true} target='_blank' href={IndiaBusiness}> Download Business Letter</a>,
 ...
 
  {
    ...
    column2: {
      content: ["Sponsor Invitation Letter for business travelers:",
      <a download={true} target='_blank' href={IndiaSponsor}> Download Sponsor Invitation Letter</a>,
          "One completed Form, MUST be signed."],
    },
  },
  ...
  {
    id: 7,
    column1: "Letter of Incorporation",
    column2: {
      content: [
        "A Letter of Incorporation from the host company in India.",
      ]
    },
  },
  
  {
    ...
    column2: {
      content: [
        "Parental Authorization Form for minors travelers:",
        <a download={true} target='_blank' href={IndiaMinors}> Download Parental Authorization Form</a>,
  ...
  },
  {
    ...
    column2: {
      content: [
        ...
        "Persons of Indian origin who have NOT renounced Indian citizenship or CANNOT SHOW PROOF of renunciation must first apply for renunciation directly through CKGS:",
        <a href="http://www.in.ckgs.us" target="_blank"></a>
      ],
    },
  },
  {
    ...
    column2: {
      content: [
        "Religious Undertaking Letter for religious travelers:",
        <a download={true} target='_blank' href={IndiaReligious}>Download Religious Undertaking Letter</a>,
        "One completed Form, MUST be signed.",
        "Journalist Undertaking Letter for journalist travelers:",
        <a download={true} target='_blank' href={IndiaJournalist}>Download Journalist Undertaking Letter</a>,
        "One completed Form, MUST be signed."
      ],
    },
  },
...
const datatable1 = [
    ["Multiple","$227.90/$307.90", "10-14 Business Days", "Up to 180 days", "1 Year/5 Years"],
  ];
const datatable2 = [
    ["Regular/ Rush","Single/Multiple","$269.90/$753.90", "7-14 Business Days", "Up to 180 days", "1 Year/5 Years"],
  ];
  
  const datatable3 = [
    ["$90.00", "10-14 Business Days"],
    ["$140.00", "7-10 Business Days"],
...
function Business_Us_Visa_India() {
  return (
    <div>
      <div>
      ...
      <div className="req-table-container">
        ...
        <div className="Detailsdata_descripition">
          ...
          <center>
          <h3 className="costing-Header">CONSULAR FEES(UK NATIONALITIES)</h3>
        </center>
        <table className="costing-responsive-table">
          <thead>
            <tr>
        ...
        <div className="Detailsdata_descripition">
          ...
          <center>
          <h3 className="costing-Header"> CONSULAR FEES (SPECIAL)</h3>
        </center>
        <div className="Detailsdata_descripition">
        <h6>Special fees apply to:
        </h6>
        </div>
        <table className="costing-responsive-table">
          <thead>
...
export default Business_Us_Visa_India;