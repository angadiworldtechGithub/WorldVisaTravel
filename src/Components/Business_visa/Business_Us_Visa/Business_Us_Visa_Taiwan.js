...
import TaiwanAuthorization from "../../../legalizationpdf/TaiwanAuthorization.pdf"
  ...
  const tableData = [
...

    {
      ...
      column2: {
        content: [
          <a download={true} target='_blank' href={TaiwanAuthorization}>Download Application Form</a>,
          "One completed Visa Applications, MUST be printed and signed.          ",
