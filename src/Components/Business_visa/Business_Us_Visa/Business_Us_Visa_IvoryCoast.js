...
import Cote_dIvoire_Visa_App from "../../../legalizationpdf/Cote_dIvoire_Visa_App.pdf";
...
const tableData = [
...

  {
    ...
    column2: {
      content: [
        "A letter of invitation from host organization in Cote d’Ivoire.",
      ],
    },
  },
  {
  ...
  },
  {
    ...
    column2: {
      content: [
        ...
        <a download={true} target='_blank' href={Cote_dIvoire_Visa_App}>Download Visa Application</a>,
...
function Business_Us_Visa_IvoryCoast() {
  return (
    <div>
      <div>
...
export default Business_Us_Visa_IvoryCoast;