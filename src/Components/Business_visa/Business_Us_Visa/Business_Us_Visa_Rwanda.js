...
import RwandaVisa from "../../../legalizationpdf/RwandaVisa.pdf"
  ...
  const tableData = [
...

    {
        ...
        column2: {
          content: [
            "A letter of invitation from host organization in Rwanda.            ",
          ],
        },
      },
...

    {
      ...
      column2: {
        content: [
          <a download={true} target='_blank' href={RwandaVisa}>Download Application Form</a>,
...
const datatable1 = [
    ['Regular','Single', '$35.00/ $65.00/ $95.00', '13-15 Business Days		' ,'	Up to 90 days', '	1 Month/ 2 Months/ 3 Months   '],
    ['Regular','Multiple', '$55.00/ $105.00/ $155.00', '13-15 Business Days		' ,'	Up to 90 days', '	1 Month/ 2 Months/ 3 Months   '],
    ['Rush','Single', '$65.00/ $95.00/ $125.00', '4-5 Business Days		' ,'	Up to 90 days', '	1 Month/ 2 Months/ 3 Months   '],
    ['Rush','Multiple', '$85.00/ $135.00/ $185.00', '4-5 Business Days		' ,'	Up to 90 days', '	1 Month/ 2 Months/ 3 Months   '],
