...
"A copy of your Driver’s License, Major Utility Bill (Water, Gas, Electric, etc.), or a copy of valid lease agreement."          ],
...

    {
        ...
        column2: {
          content: [
"Sponsor Invitation Letter for business travelers: Download Sponsor Invitation Letter",
...
"A Letter of Incorporation from the host company in India.",
...

    {
      ...
      
      {
        ...
        "Note: The Embassy will not accept double-sided applications.Additional Particulars Form for ALL travelers:",
        "Download Additional Particulars Form",
        "One completed Form, MUST be signed.        "  
        ],
        },
      },
...
const datatable1 = [
    ['Regular','Single/Multiple', '$202.90', '10-12 Business Days' ,'Up to 180 days', 'Up to 1 Year/ 10 Years'],
    ['Rush','Single/Multiple', '$202.90', '7-10 Business Days' ,'Up to 180 days', 'Up to 1 Year/ 10 Years'],
