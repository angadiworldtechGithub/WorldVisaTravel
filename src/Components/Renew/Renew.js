...
import "./Renew.css"; // Create a CSS file for styling
  ...
  const tableData = [
    {
      ...
      column2: {
        content: [
          "Recent passport and second valid passport (if applicable) are required.",
        ],
      },
    },
    {
  ...
  return (
    <div className="reqdouments">
      <center className="reqdouments-header">
        <h3 className='costing-Header'>RENEW A U.S. PASSPORT</h3>
