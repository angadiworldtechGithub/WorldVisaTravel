...
import BrazilWhiteGlove from "../../../legalizationpdf/BrazilWhiteGlove.pdf";
  ...
  const tableData = [
...

    {
      ...
      column2: {
        content: [
          <a  href='https://formulario-mre.serpro.gov.br/sci/web/pacomPasesWebInicial.jsf'>Online Application Form</a>,
...
const datatable1 = [
  ['Single/Multiple', '$0', '5-7 Business Days' ,'Up to 30 days','3 Months'],
  

];

const datatable2 = [
  ['$110.00','5-7 Business Days'],
...
export default OfficialUsBrazil;