...
const tableData = [
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={GhanaRegularVisa}>Download Application Form</a>,
...
const datatable1 = [
  ["Single/Multiple", "$0", "2-4 Business Days", "	Up to 30 days","3 Months"],
];

const datatable2 = [
  [ "$120.00", "	2-4 Business Days"]
];
const datatable3 = [
...
export default OfficialUsGhana;
