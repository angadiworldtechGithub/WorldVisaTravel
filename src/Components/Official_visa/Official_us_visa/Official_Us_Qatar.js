...
const datatable1 = [
  ["Single/Multiple", "$0", "7-10 Business Days", "Up to 30 Days", "1 Year"],
];

const datatable2 = [["$90.00", "7-10 Business Days"]];
const datatable3 = [
...
export default OfficialUsQatar;
