...
import UruguayODVisa from "../../../legalizationpdf/UruguayODVisa.pdf";
...
const tableData = [
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={UruguayODVisa}>Download Application Form</a>,
...
const datatable1 = [
  ["Single", "$0", "1-2 Business Days", "Up to 30 days", "3 Months"],
];

const datatable2 = [["$90.00", "1-2 Business Days"]];
const datatable3 = [
...
export default OfficialUsUruguay;
