  ...
  const tableData = [
    {
      ...
      column1: "Passport",
      column2: {
        content: ["U.S. Official/Diplomatic Passport – have to be valid at least 6 months beyond intended stay and must have at least two blank visa pages.","For Additional Visa Pages and U.S. Passport Renewal."],
      },
    },
    {
      id: 2,
