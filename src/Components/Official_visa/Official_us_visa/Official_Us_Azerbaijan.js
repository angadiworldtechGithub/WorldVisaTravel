...
import azerbaijan_Visa_Application_Form from "../../../legalizationpdf/azerbaijan_Visa_Application_Form.pdf";
  ...
  const tableData = [
...

    {
      ...
      column2: {
        content: [
          <a download={true} target='_blank' href={azerbaijan_Visa_Application_Form}>Download Visa Application</a>,
...
const datatable1 = [
  ['Single/Mutliple', '$0', '4-10 Business Days' ,'Up to 30 days', '3 Months']
];

const datatable2 = [
  ['$90.00','4-10 Business Days']
...
export default OfficialUsAzerbaijan;