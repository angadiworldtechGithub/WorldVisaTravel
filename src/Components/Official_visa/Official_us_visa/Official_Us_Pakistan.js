...

  {
    ...
    column2: {
      content: [
        ...
        "Four completed Visa Applications, MUST be signed.",
...
const datatable1 = [
  ["Single", "$0", "More than 4 Weeks", "Up to 30 Days", "3 Months"],
];

const datatable2 = [["$90.00", "More than 4 Weeks"]];
const datatable3 = [
...
export default OfficialUsPakistan;
