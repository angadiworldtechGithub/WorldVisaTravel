...
import AfghanistanOfficialUs from "../../../Pages/Legalizations/OfficialUs/AfghanistanOfficialUs.pdf";
...
const tableData = [
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={AfghanistanOfficialUs}>Download Visa Application</a>,
