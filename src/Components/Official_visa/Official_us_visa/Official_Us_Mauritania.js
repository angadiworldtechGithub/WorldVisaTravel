...
import MauritaniaVisa from "../../../legalizationpdf/MauritaniaVisa.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: [
        "Four passport-type photographs.", <a href='https://travel.state.gov/content/travel/en/passports/how-apply/photos.html' target="_blank" >Quality Requirements for Passport Book & Passport Card Photographs</a>
      ],
    },
  },
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={MauritaniaVisa}>Download Application Form</a>,
...
const datatable1 = [
  ["Single", "$0", "5-7 Business Days", "Up to 30 Days","3 Months"],
];
...
export default OfficialUsMauritania;
