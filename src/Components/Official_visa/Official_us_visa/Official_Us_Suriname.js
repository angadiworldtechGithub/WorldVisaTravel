...
import SurinameOfficialUs from "../../../Pages/Legalizations/OfficialUs/SurinameVisa.pdf";
const tableData = [
  {
    id: 1,
    column1: "Passport",
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={SurinameOfficialUs}>Download Application Form</a>,
...
const datatable1 = [
  ["Single", "$0", "4-5 Business Days", "Up to 90 Days", "3 Months"],
];

const datatable2 = [["$90.00", "4-5 Business Days"]];
const datatable3 = [
...
export default OfficialUsSuriname;
