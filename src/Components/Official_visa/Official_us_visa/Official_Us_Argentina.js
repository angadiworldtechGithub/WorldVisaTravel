...
import ArgentinaOfficialApplication from "../../../legalizationpdf/ArgentinaOfficialApplication.pdf";
import ArgentinaDiplomaticApplication from "../../../legalizationpdf/ArgentinaDiplomaticApplication.pdf";
  ...
  const tableData = [
...

    {
      ...
      column2: {
        content: [
          <a download={true} target='_blank' href={ArgentinaDiplomaticApplication}>Download Diplomatic Visa Application</a>,
          <a download={true} target='_blank' href={ArgentinaOfficialApplication}>Download Official Visa Application</a>,
...
const datatable1 = [
  ['Single', '$0', '2-3 Business Days' ,'Up to 30 days', '3 Months']

];

const datatable2 = [
  ['$90.00','2-3 Business Days']
...
export default OfficialUsArgentina;