...
import CapeVerdeOfficialUs from "../../../Pages/Legalizations/OfficialUs/CapeVerdeVisaOfficialUs.pdf";
...
const tableData = [
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={CapeVerdeOfficialUs}>Download Application Form</a>,
...
const datatable1 = [
  ["Single", "$0", "2 Business Days", "Up to 90 Days", "Up to 90 Days"],
];
...
export default OfficialUsCapeVerde;
