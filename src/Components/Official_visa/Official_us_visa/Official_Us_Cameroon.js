...
import CameroonOfficialUs from "../../../Pages/Legalizations/OfficialUs/CameroonVisaApp-1OfficialUs.pdf";
...
const tableData = [
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={CameroonOfficialUs}>Download Application Form</a>,
...
const datatable1 = [
  ["Single", "$0", "5-7 Business Days", "Up to 60 days", "3 Months"],
];

const datatable2 = [
  ["$90.00", "	5-10 Business Days"],
  ["$140.00", "2-4 Business Days"],
];
const datatable3 = [
...
export default OfficialUsCameroon;
