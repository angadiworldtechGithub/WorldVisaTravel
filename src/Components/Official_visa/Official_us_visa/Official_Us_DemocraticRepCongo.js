...
import DRCOfficialUs from "../../../Pages/Legalizations/OfficialUs/DRCVisa1OfficialUs.pdf";
...
const tableData = [
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={DRCOfficialUs}>Download Application Form</a>,
...
const datatable1 = [
  ["Single/Multiple", "$0", "At Least 15 Business Days", "Up to 90 days", "3 Months"],
];

const datatable2 = [
  ["Regular", "$90.00", "At Least 15 Business Days"],
  ["Rush (if possible)", "$140.00", "5 Business Days"],
];
const datatable3 = [
...
function OfficialUsDemocraticRepCongo() {
  return (
    <div>
      <div>
...
export default OfficialUsDemocraticRepCongo;
