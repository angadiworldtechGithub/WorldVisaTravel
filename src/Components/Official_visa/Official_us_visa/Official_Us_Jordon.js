...
import JordanOfficialUs from "../../../Pages/Legalizations/OfficialUs/JordanVisa.pdf";
...
const tableData = [
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={JordanOfficialUs}>Download Application Form</a>,
...
const datatable1 = [
  ["Multiple", "$0", "2-4 Business Days", "Up to 30 Days", "3 Months"],
];
...
export default OfficialUsJordon;
