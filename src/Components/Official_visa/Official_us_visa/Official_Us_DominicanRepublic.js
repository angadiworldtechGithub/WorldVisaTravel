...
import DominicanRepublicVisa from "../../../legalizationpdf/DominicanRepublicVisa.pdf";
const tableData = [
  {
    id: 1,
    column1: "Passport",
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={DominicanRepublicVisa}>Download Application Form</a>,
...
const datatable1 = [
  ["Single/Multiple", "$0", "	Up to 30 days", "	3 Months", "4 Business Days"],
];
...
function OfficialUsDominicanRepublic() {
  return (
    <div>
      <div>
...
export default OfficialUsDominicanRepublic;
