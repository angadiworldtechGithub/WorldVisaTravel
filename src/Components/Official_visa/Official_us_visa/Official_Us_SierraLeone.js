...
const datatable1 = [
  ["Single/Multiple", "$0", "3-5 Business Days", "Up to 30 days", "6-12 Months"],
];

const datatable2 = [["$90.00", "3- 5Business Days"]];
const datatable3 = [
...
function OfficialUsSierraLeone() {
  return (
    <div>
      <div>
...
export default OfficialUsSierraLeone;
