...
import Israel_new_official_visa_application_form from "../../../legalizationpdf/Israel_new_official_visa_application_form.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: [
        ...
        "One completed and signed Authorization Letter.",
      ],
    },
  },
  {
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={Israel_new_official_visa_application_form}>Download Application Form</a>,
        "One completed Visa Applications, MUST be signed in BLUE INK.",
      ],
    },
  },
...
const datatable1 = [
  ["Multiple", "$0", "10-14 Business Days", "Up to 90 Days", "2 Years"],
];
...
export default OfficialUsIsrael;
