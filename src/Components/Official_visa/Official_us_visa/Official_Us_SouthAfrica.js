...
import SouthAfricaVisa1 from "../../../legalizationpdf/SouthAfricaVisa1.pdf";
...
const tableData = [
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={SouthAfricaVisa1}>Download Application Form</a>,
...
const datatable2 = ["Please contact our office for more assistance."];
const datatable3 = [
...
function OfficialUsSouthAfrica() {
  return (
    <div>
      <div>
...
export default OfficialUsSouthAfrica;
