...
import AlgeriaVisaOfficialUs from "../../../Pages/Legalizations/OfficialUs/AlgeriaVisaOfficialUs.pdf";
  ...
  const tableData = [
...

    {
      ...
      column2: {
        content: [
          "A letter of invitation from host government organization in Algeria is required.",
        ],
      },
    },
...

    {
      ...
      column2: {
        content: [
          <a download={true} target='_blank' href={AlgeriaVisaOfficialUs}>Download Visa Application</a>,
...
const datatable1 = [
  ['Single/Multiple', '$', '5-10 Business Days']
...
export default OfficialUsAlgeria;