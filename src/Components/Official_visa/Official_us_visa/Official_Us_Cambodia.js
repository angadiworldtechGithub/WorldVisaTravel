...
import CambodiaOfficialUs from "../../../Pages/Legalizations/OfficialUs/CambodiaVisaOfficialUs.pdf";
  ...
  const tableData = [
    ...
    },
    {
      ...
      column2: {
        content: [
          "One passport-type photographs. ",<a href='https://travel.state.gov/content/travel/en/passports/how-apply/photos.html'>Quality Requirements for Passport Book & Passport Card Photographs</a>
        ],
      },
    },
...

    {
      ...
      column2: {
        content: [
          <a download={true} target='_blank' href={CambodiaOfficialUs}>Download Application Form</a>,
...
const datatable1 = [
  ['Single/Multiple', '$0', '3-4 Business Days' ,'Up to 30 days','1 Year']
...
export default OfficialUsCambodia;