...
import UAEVisa from "../../../legalizationpdf/UAEVisa.pdf";
  ...
  const tableData = [
    ...
    {
      id: 2,
      column1: "Photocopy of Passport",
      column2: {
        content: [
          "One photocopy of U.S. Official/Diplomatic Passport (in color).",
    ...
    {
      id: 4,
      column1: "Department of State Letter",
      column2: {
        content: [
...

    {
      ...
      column2: {
        content: [
          <a download={true} target='_blank' href={UAEVisa}>Download Application Form</a>,
          "Two completed Visa Applications, MUST be typed, printed in color, and signed.",
        ],
      },
    },
...
const datatable1 = [
  ['Multiple', '$0', '4-6 Business Days' ,'Up to 180 days', '5 Years']
...
function OfficialUsUnitedArabEmirates() {
  return (
   <div>
   <div>
...
export default OfficialUsUnitedArabEmirates;