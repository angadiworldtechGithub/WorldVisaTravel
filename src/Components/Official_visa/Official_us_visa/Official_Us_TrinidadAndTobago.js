...
import TnTOfficialUs from "../../../Pages/Legalizations/OfficialUs/TnTVisa.pdf";
...
const tableData = [
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={TnTOfficialUs}>Download Application Form</a>,
...
const datatable1 = [
  ["Single/Multiple", "$0", "3 Business Days", "Up to 30 days", "3 Months"],
];

const datatable2 = [["$90.00", "3 Business Days"]];
const datatable3 = [
...
function OfficialUsTrinidadAndTobago() {
  return (
    <div>
      <div>
...
export default OfficialUsTrinidadAndTobago;
