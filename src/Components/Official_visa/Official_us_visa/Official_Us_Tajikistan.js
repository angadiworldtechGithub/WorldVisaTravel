...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: [
        "Three passport-type photographs.", <a href='https://travel.state.gov/content/travel/en/passports/how-apply/photos.html' target="_blank" >Quality Requirements for Passport Book & Passport Card Photographs</a>
      ],
    },
  },
...
const datatable1 = [
  ["Single/Multiple", "$0", "6-7 Business Days", "-", "-"],
];

const datatable2 = [["$90.00", "5-7 Business Days"]];
const datatable3 = [
...
export default OfficialUsTajikistan;
