...
import NigerVisaApp from "../../../legalizationpdf/NigerVisaApp.pdf";
...
const tableData = [
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={NigerVisaApp}>Download Application Form</a>,
...
const datatable1 = [
  ["Double/Multiple", "$0", "5 Business Days", "Up to 30 Days","1 Year"],
];
...
export default OfficialUsNiger;
