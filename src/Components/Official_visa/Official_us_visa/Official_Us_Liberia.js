...
import LiberiaOfficialUs from "../../../Pages/Legalizations/OfficialUs/Liberia-Application.pdf";
...
const tableData = [
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={LiberiaOfficialUs}>Download Application Form</a>,
...
export default OfficialUsLiberia;
