...
const datatable1 = [
  ["Single/Multiple", "$0", "4 Business Days", "Up to 90 days", "	6-12 Months"],
];

const datatable2 = [["$90.00", "4 Business Days"]];
const datatable3 = [
...
export default OfficialUsThailand;
