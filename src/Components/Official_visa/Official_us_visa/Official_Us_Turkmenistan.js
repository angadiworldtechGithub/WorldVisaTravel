...
import TurkmenistanOfficialUs from "../../../Pages/Legalizations/OfficialUs/TurkmenistanVisa.pdf";
...

  {
    ...
    column2: {
      content: [
        ...
        <a download={true} target='_blank' href={TurkmenistanOfficialUs}>Download Application Form</a>,
...
const datatable1 = [
  ["Single", "$20", "5-10 Business Days", "-", "3 Months"],
];

const datatable2 = [["$90.00", "5-10 Business Days"]];
const datatable3 = [
...
function OfficialUsTurkmenistan() {
  return (
    <div>
      <div>
...
export default OfficialUsTurkmenistan;
