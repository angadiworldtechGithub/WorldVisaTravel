...
import BarbadosVisa from "../../../legalizationpdf/BarbadosVisa.pdf";
  ...
  const tableData = [
...

    {
      ...
      column2: {
        content: [
          <a download={true} target='_blank' href={Barbados}>Download Visa Application</a>,
...
const datatable1 = [
  ['Single/Multiple', '$0', '5-10 Business Days' ,'Up to 30 days','3 Months'],
...
export default OfficialUsBarbados;