...
import EcuadorOfficialUs from "../../../Pages/Legalizations/OfficialUs/EcuadorVisa.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: [
        "One passport-type photograph.", <a href='https://travel.state.gov/content/travel/en/passports/how-apply/photos.html'>Quality Requirements for Passport Book & Passport Card Photographs</a>
      ],
    },
  },
...

  {
    ...
    column2: {
      content: [
        "An official letter of invitation from U.S. Embassy in Belarus.",
      ],
    },
  },
  {
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={EcuadorOfficialUs}>Download Application Form</a>,
...
const datatable1 = [
  ["Single", "$0", "1-2 Business Days", "Up to 90 days", "	3 Months"],
];

const datatable2 = [
  [ "$90.00", "	1-2 Business Days"]
];
const datatable3 = [
...
export default OfficialUsEcuador;
