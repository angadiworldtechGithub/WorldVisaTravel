...
import BFA_Visa from "../../../legalizationpdf/BFA_Visa.pdf"
  ...
  const tableData = [
    ...
    },
    {
      ...
      column2: {
        content: [
          "One passport-type photographs.",  <a href='https://travel.state.gov/content/travel/en/passports/how-apply/photos.html' target="_blank" >Quality Requirements for Passport Book & Passport Card Photographs</a>
        ],
      },
    },
...

    {
      ...
      column2: {
        content: [
          <a download={true} target='_blank' href={BFA_Visa}>Download here</a>,
...
const datatable1 = [
  ['Single', '$0', '3-4 Business Days' ,'90 days','3 Months']
  

];

const datatable2 = [
  ['$75.00','3-4 Business Days']
...
function OfficialUsBurkinaFaso() {
  return (
   <div>
   <div>
...
export default OfficialUsBurkinaFaso;