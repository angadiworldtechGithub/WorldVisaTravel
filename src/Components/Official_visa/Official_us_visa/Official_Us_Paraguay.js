...
import PARAGUAY_NEW_APPLICATION from "../../../legalizationpdf/PARAGUAY_NEW_APPLICATION.pdf";
...
const tableData = [
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={PARAGUAY_NEW_APPLICATION}>Download Application Form</a>,
...
export default OfficialUsParaguay;
