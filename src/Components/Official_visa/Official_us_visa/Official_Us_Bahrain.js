...
import BahrainOfficialUs  from "../../../Pages/Legalizations/OfficialUs/BahrainVisaOfficialUs.pdf";
  ...
  const tableData = [
...

    {
      ...
      column2: {
        content: [
          <a download={true} target='_blank' href={BahrainOfficialUs}>Download Application Form</a>,
...
const datatable1 = [
  ['Multiple', '$0', '2-3 Weeks' ,'Up to 30 days per Entry','5 Years'],
   ...
   <div>
    ...
    <center><h3 className='costing-Header'>CONSULAR FEES</h3></center>
     ...
     <center><h3 className='costing-Header'> WORLD VISA TRAVEL SERVICE FEES</h3></center>
      ...
      <h6>Update: FedEx charges an additional $6.50 for residential areas. Please call for shipping to Alaska/Hawaii.
...
export default OfficialUsBahrain;