...
import LibyaOfficialUs from "../../../Pages/Legalizations/OfficialUs/LibyaVisa.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: [
        "	In order to obtain an Official/Diplomatic Libyan Visa, you will need a reference/approval",
        "number from the Libyan Ministry of Foreign Affairs (MFA).Your Visa application cannot be submitted to the Libyan Embassy without this Visa approval being in place.",
        "The US Embassy in Tripoli must obtain the approval on your behalf.",
      ],
    },
  },
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={LibyaOfficialUs}>Download Application Form</a>,
...
const datatable1 = [
  ["Single", "$0", "3-5 Business Days", "Up to 30 Days", "3 Months"],
];

const datatable2 = [["$90.00", "3-5 Business Days"]];
const datatable3 = [
...
export default OfficialUsLibya;
