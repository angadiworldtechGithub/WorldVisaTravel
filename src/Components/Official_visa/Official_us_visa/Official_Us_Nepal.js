...
import NepalOfficialApps from "../../../legalizationpdf/NepalOfficialApps.pdf";
import NepalDiplomaticApps from "../../../legalizationpdf/NepalDiplomaticApps.pdf";
...
const tableData = [
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={NepalOfficialApps}>Download Official Application Form</a>,
        <a download={true} target='_blank' href={NepalDiplomaticApps}>Download Diplomatic Application Form</a>,
...
const datatable1 = [
  ["Multiple", "$0", "5 Business Days", "Up to 30 Days","6 Months"],
];
...
export default OfficialUsNepal;
