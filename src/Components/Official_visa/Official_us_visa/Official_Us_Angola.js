...
import AngolaVisaOfficialUs from "../../../Pages/Legalizations/OfficialUs/AngolaVisaOfficialUs.pdf";
...
const tableData = [
...

  {
    ...
    column2: {
      content: [
        "A letter of invitation from host government organization in Angola is required.",
      ],
    },
  },
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={AngolaVisaOfficialUs}>Download Visa Application</a>,
...
const datatable1 = [
  ["Single", "$0", "5-10 Business Days", "Up to 30 days", "3 Months"],
];
...
export default OfficialUsAngola;
