...
import ARMENIAvisaappform  from "../../../legalizationpdf/ARMENIAvisaappform.pdf";
  ...
  const tableData = [
...

    {
      ...
      column2: {
        content: [
          <a download={true} target='_blank' href={ARMENIAvisaappform}>Download Visa Application</a>,
...
const datatable1 = [
  ['Single/Multiple', '$0', '4 Business Days' ,'Up to 90 days', '6 Months']
...
export default OfficialUsArmenia;