...
import SudanOfficialUs from "../../../Pages/Legalizations/OfficialUs/SudanVisa.pdf";
const tableData = [
  {
    id: 1,
    column1: "Passport",
  ...
  {
    id: 4,
    column1: "Visa Approval",
    column2: {
      content: ["	A Visa Approval from the Sudan Ministry of Foreign Affairs.",
    "The waiting time for the approval and visa can take up to 4-8 weeks.",
"It is recommended that you obtain an approval before submitting a Visa application.",
"The Embassy of Sudan in Washington DC will only issue a visa for travel to Sudan,",
"when the Embassy has received Approval from the Ministry of Foreign Affairs."],
    },
  },
  {
    id: 5,
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={SudanOfficialUs}>Download Application Form</a>,
...
const datatable1 = [
  ["Single", "$0", "4-5 Business Days", "Up to 30 days", "3 Months"],
];

const datatable2 = [["$90.00", "4-6 Weeks"],["$140.00", "Less Than 4 Weeks"]
];
const datatable3 = [
...
export default OfficialUsSudan;
