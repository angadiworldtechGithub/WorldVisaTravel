...
import BelarusOfficialUs from "../../../Pages/Legalizations/OfficialUs/BELARUS-VISA-applicationOfficialUs.pdf";
  ...
  const tableData = [
...

    {
      ...
      column2: {
        content: [
          <a download={true} target='_blank' href={BelarusOfficialUs}>Download Appication Form</a>,
...
const datatable1 = [
  ['Regular','Single/Double/Multiple', '$0', '5-6 Business Days' ,'Up to 90 days','3 Months'],
  ['Rush','Single/Double/Multiple', '$0', '1-2 Business Days' ,'Up to 90 days','3 Months'],
...
export default OfficialUsBelarus;