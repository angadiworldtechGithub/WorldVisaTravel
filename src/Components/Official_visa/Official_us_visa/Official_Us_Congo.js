...
import CongoOfficialUs from "../../../Pages/Legalizations/OfficialUs/CongoVisa-1OfficialUs.pdf";
...
const tableData = [
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={CongoOfficialUs}>Download Visa Application</a>,
...
export default OfficialUsCongo;
