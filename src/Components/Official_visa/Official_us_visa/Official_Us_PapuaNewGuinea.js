...

  {
    ...
    column2: {
      content: [
        ...
        "Download Supplemental Health Form",
...
const datatable1 = [
  ["Single", "$0", "5-7 Business Days", "Up to 60 Days","6 Months"],
];
...
function OfficialUsPapuaNewGuinea() {
  return (
    <div>
      <div>
...
export default OfficialUsPapuaNewGuinea;
