    ...
    <div className="footer">
      <div class="footer-container1">
        <div class="footer-item-left">
          <h3 className="footer-top-header">
            <i className="footer-top-icon">
              <HiOutlineMailOpen />
            </i>
      ...
      <div class="footer-container2">
        <div class="footer-item-right">
          ...
          <p className="footer-text">
            World visa travel is simplest solution for processing your all type
            of visa.Say goodbye to endless hashles and confusions.
          </p>
          <div
