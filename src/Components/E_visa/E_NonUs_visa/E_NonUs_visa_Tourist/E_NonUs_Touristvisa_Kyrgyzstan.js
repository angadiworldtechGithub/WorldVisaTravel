...
const tableData = [
  ...
  {
    id: 4,
    column1: "Kyrgyzstan eVisa Questionnaire.",
    column2: {
...
const datatable1 = [
  ["Single","","2 - 4 Business Days","90 Days","30 Days Valid"],
];
...
function E_NonUs_Touristvisa_Kyrgyzstan () {
  return (
    <div>
      <div>
...
export default E_NonUs_Touristvisa_Kyrgyzstan;
