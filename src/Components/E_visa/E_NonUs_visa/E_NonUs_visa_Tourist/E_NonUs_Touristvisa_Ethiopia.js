...
import Ethiopia_EVisa_Questionnaire_ADMIN from "../../../../legalizationpdf/Ethiopia_EVisa_Questionnaire_ADMIN.pdf"
...
const tableData = [
  ...
  {
    id: 4,
    column1: "Ethiopia eVisa Questionnaire",
    column2: {
      content: ["One completed",
      <a download={true} target='_blank' href={Ethiopia_EVisa_Questionnaire_ADMIN}>Ethiopia eVisa Questionnaire.</a>,
  ...
  {
    id: 6,
    column1: "Note: Visa Validity",
    column2: {
      content: [
     "Please Note:",
     "Travelers must arrive in Ethiopia via Bole International Airport in Addis Ababa.",
     "Visas will be valid for a single entry, for a stay of 30 or 90 days. Your visa validity will begin on the date of entry listed on your questionnaire.",
    ],
    },
  },
  {
...
const datatable1 = [
  ["Single", "$87.00", "3 - 6 Business Days","30 Days","3 Months valid"],
  ["Single", "$87.00", "3 - 6 Business Days","90 Days","3 Months valid"],
];
...
function E_NonUs_Touristvisa_Ethiopia() {
  return (
    <div>
      <div>
...
export default E_NonUs_Touristvisa_Ethiopia;
