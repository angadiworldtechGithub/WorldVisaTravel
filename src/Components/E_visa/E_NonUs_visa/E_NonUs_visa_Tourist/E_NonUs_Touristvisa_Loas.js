...
const tableData = [
  ...
  {
    id: 4,
    column1: "Laos eVisa Questionnaire",
    column2: {
  ...
  {
    id: 5,
    column1: "One Digital Passport-Style Photograph",
    column2: {
      content: [
...
const datatable1 = [
  ["Single","$56.75","4 - 6 Business Days","60 Days","30 Days Valid"],
];
...
function E_NonUs_Touristvisa_Loas() {
  return (
    <div>
      <div>
...
export default E_NonUs_Touristvisa_Loas;
