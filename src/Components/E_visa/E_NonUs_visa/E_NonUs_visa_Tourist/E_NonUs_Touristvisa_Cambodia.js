...
import Cambodia_EVisa_Quest_ADMIN from "../../../../legalizationpdf/Cambodia_EVisa_Quest_ADMIN.pdf"
...
const tableData = [
  {
    ...
    column2: {
      content: [
        "A clear color scan of the information/photo page of your original valid signed passport.",
        "This must show the full photo page and the adjacent page, with no parts of the passport cut off or obscured.",
        "All lines of coding at the bottom of the information page must be legible and visible.",
        "Your passport must have at least one blank visa page and more than six months before expiry. Please scan this at 300 DPI or greater.",
      ],
    },
  },
  {
    id: 2,
    column1: "Proof of Vaccination",
    column2: {
      content: [
     "Please provide a scan copy of your Covid-19 Vaccination Card.",
     "Card must show complete list of vaccines."
      ],
    },
  },
  ...
  {
    id: 4,
    column1: "Cambodia eVisa Questionnaire.",
    column2: {
      content: ["One completed",
      <a download={true} target='_blank' href={Cambodia_EVisa_Quest_ADMIN}>Cambodia eVisa Questionnaire.</a>,
...

  {
    ...
    column2: {
      content: [
        "A copy of hotel reservations showing your name.",
      ],
    },
  },
  ...
  {
    id: 6,
    column1: "Note: eVisa Restrictions",
    column2: {
      content: [
        "Cambodia eVisas are available for TOURISTS only, and are valid for 3 months from date of issue, for a stay of up to 30 days.",
        "Cambodia eVisas are valid for entry at the international airports in Phnom Penh and Siem Reap or at the land border crossings at Bavet, Cham Yeam, and Poi Pet.",
      ],
    },
  },
  {
...
const datatable1 = [
  ["Single", "$42.00", "2 - 4 Business Days","30 Days","3 Months valid"],
...
function E_NonUs_Touristvisa_Cambodia() {
  return (
    <div>
      <div>
...
export default E_NonUs_Touristvisa_Cambodia;
