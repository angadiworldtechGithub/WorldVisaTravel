...
const tableData = [
  ...
  {
    id: 4,
    column1: "South Korea eVisa Questionnaire",
    column2: {
  ...
  {
    id: 6,
    column1: "Copy of Signed US Business Letter",
    column2: {
      content: [
      "A scanned copy of a business letter from your US company.",
      ...
      "It must be on letterhead and have a pen-to-paper signature of a representative of the US company other than the applicant.",
    ],
    },
  },
...
const datatable1 = [
  ["Multiple", "$15.00", "2 - 4 Business Days","30 Days","1 Year valid"],
];
...
function E_NonUs_Touristvisa_Korea() {
  return (
    <div>
      <div>
...
export default E_NonUs_Touristvisa_Korea;
