...
const tableData = [
  ...
  {
    id: 4,
    column1: "Business invitation",
    column2: {
      content: [
     "A copy of the invitation from the company in Zambia, certified by the Ministry of Foreign Affairs."
      ],
    },
  },
  {
    ...
    column2: {
      content: [
     "Copy of the sending company's Certificate of Incorporation."
    ],
    },
  },
...
const datatable1 = [
  ["Single","$36.00","4 - 6 Business Days","90 Days","3 months Valid"],
  ["Double","$36.00","4 - 6 Business Days","90 Days","3 months Valid"],
  ["Multiple","$36.00","4 - 6 Business Days","90 Days","3 months Valid"],
];
...
function E_NonUs_Businessvisa_Zambia() {
  return (
    <div>
      <div>
...
export default E_NonUs_Businessvisa_Zambia;
