...
const datatable1 = [
['Single','$159.00','4-6 Business Days ','Up to 30 days','3 Months']

];

const datatable2 = [
     ['$90.00','4-6 Business Days'],
     ['$140.00','4-6 Business Days']
];
...
export default Tourist_Us_Sudan;