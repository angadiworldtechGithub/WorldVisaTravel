...
const datatable1 = [
['Regular/Rush','Single/Double','$105.00/$120.00/$205.00/$235.00','3-12 Business Days','Up to 90 days','1-3 Months']
];
...
function Tourist_Us_Kyrgyzstan() {
  return (
   <div>
   <div>
...
export default Tourist_Us_Kyrgyzstan;