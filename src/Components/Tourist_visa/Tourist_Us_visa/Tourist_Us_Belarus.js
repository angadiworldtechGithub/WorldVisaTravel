...
import BelarusVisa from "../../../legalizationpdf/BelarusVisa.pdf"
  ...
  const tableData = [
...

    {
      ...
      column2: {
        content: [
         "Evidence of international medical insurance.",
        ],
      },
    },
...

    {
      ...
      column2: {
        content: [
      "An official letter of invitation from host organization in Belarus.",
        ],
      },
    },
...

    {
        ...
        column2: {
          content: [
            "Confirmation from the Ministry of Foreign Affairs of Belarus.",
          ],
        },
      },
...

    {
        ...
        column2: {
          content: [
           "A copy of child’s Birth Certificate and parents’ passports.",
          ],
        },
      },
      ...
      },
      {
        ...
        column2: {
          content: [
            <a download={true} target='_blank' href={BelarusVisa}> Download Application Form</a>,
...
const datatable1 = [
  ['Regular','Single/Double/Multiple','$70.00','5-6 Business Days','Up to 90 days','3 Months'],
  ['Rush','Single/Double/Multiple','$130.00','1-2 Business Days','Up to 90 days','3 Months'],
];

const datatable2 = [
  ['Regular','$90.00','5-6 Business Days'],
  ['Rush','$125.00','1-2 Business Days'],
];
...
export default Tourist_Us_Belarus;