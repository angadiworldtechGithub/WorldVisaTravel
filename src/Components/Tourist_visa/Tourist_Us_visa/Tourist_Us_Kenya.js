...
import KenyaEastAfricaVisa from "../../../legalizationpdf/KenyaEastAfricaVisa.pdf"
  ...
  const tableData = [
    ...
    },
    {
      ...
      column2: {
        content: [
          <a download={true} target='_blank' href={KenyaEastAfricaVisa}>Download Application Form</a>,
...
const datatable1 = [
['Regular','Multiple','$105.00','5-7 Business Days','Up to 90 days','3 Months']
];
...
export default Tourist_Us_Kenya;