...
import TurkeyVisa from "../../../legalizationpdf/TurkeyVisa.pdf"
  ...
  const tableData = [
   ...
   
    {
        ...
        column2: {
          content: [
            "WVT can help you complete the Turkey Visa",
             <a download={true} target='_blank' href={TurkeyVisa}>Online Application through our White Glove Service.</a>,
            <a download={true} target='_blank' href={Turkey_Visa_White_Glove_Form }>Turkey White Glove Application Form</a>,
...
const datatable1 = [
['Multiple','Determined by Nationality','24 Hours','Up to 90 days','6 Months'],
...
export default Tourist_Us_Turkey;