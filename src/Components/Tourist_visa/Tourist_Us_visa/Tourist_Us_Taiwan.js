...
import TaiwanAuthorization from "../../../legalizationpdf/TaiwanAuthorization.pdf"
  ...
  const tableData = [
...

    {
        ...
        column2: {
          content: [
            <a href="https://visawebapp.boca.gov.tw/BOCA_MRVWeb/subroot/MRVWeb0_form.jsp">Download Application Form</a>,
            "One completed Visa Application, MUST be signed.",
            <a download={true} target='_blank' href={TaiwanAuthorization}>Print the Authorization Letter</a>,
            "One completed Visa Application, MUST be signed.",
        ],
        },
      },
...
export default Tourist_Us_Taiwan;