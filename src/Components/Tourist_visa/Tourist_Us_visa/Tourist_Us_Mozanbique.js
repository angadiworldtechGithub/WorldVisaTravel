...
import MozambiqueVisa from "../../../legalizationpdf/MozambiqueVisa.pdf"
  ...
  const tableData = [
    ...
    },  
    {
        ...
        column2: {
          content: [
            "A letter of invitation from host in Mozambique."
            ]
       },
      },  
      {
...
const datatable1 = [
['Regular/Rush','Single','$165.00/$225.00','10/2-4 Business Days','Up to 30 days','3 Months']
...
function Tourist_Us_Mozanbique() {
  return (
   <div>
   <div>
...
export default Tourist_Us_Mozanbique;