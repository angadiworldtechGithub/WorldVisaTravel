...
import PhilippinesVisa1 from "../../../legalizationpdf/PhilippinesVisa1.pdf"
  ...
  const tableData = [
    ...
    },
    {
      ...
      column2: {
        content: [
            "Two passport-type photograph.Name and signature have to be printed on the back of the photo.",
...

    {
        ...
        column2: {
          content: [
            <a download={true} target='_blank' href={PhilippinesVisa1}>Online Application Form</a>,
         "One completed Visa Application, MUST be signed and notarized.",
...
const datatable1 = [
['Single/Multiple/Multiple','$35.00/$65.00/$95.00','6-8 Business Days ','Up to 59 days','3 Months/6 Months/1 Year']
...
function Tourist_Us_Philippines() {
  return (
   <div>
   <div>
...
export default Tourist_Us_Philippines;