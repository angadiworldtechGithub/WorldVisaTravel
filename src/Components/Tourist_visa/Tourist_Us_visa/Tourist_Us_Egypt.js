...
const datatable1 = [
  ['Regular','Single','$33.00','10 Business Days','Up to 30 days','3 months'],
  ['Regular','Multiple','$68.00','10 Business Days','Up to 30 days','3 months'],
];
...
export default Tourist_Us_Egypt;