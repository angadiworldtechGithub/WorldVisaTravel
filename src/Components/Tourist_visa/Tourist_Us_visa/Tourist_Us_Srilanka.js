...
import SriLankaShortTermVisa from "../../../legalizationpdf/SriLankaShortTermVisa.pdf"
  ...
  const tableData = [
    ...
    }, 
    {
      ...
      },
      {
        ...
        column2: {
          content: [
       "A letter of invitation from host organization in Sri Lanka."
        ],
        },
      },
...

    {
        ...
        column2: {
          content: [
            <a download={true} target='_blank' href={SriLankaShortTermVisa}>Download Application Form</a>,
...
const datatable1 = [
['Double','$45.00','7-14 Business Days ','Up to 30 days','6 Months']

];

const datatable2 = [
     ['$90.00','7-14 Business Days']
...
export default Tourist_Us_Srilanka;