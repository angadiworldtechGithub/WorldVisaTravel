...
import TajikistanVisa from "../../../legalizationpdf/TajikistanVisa.pdf"
  ...
  const tableData = [
    ...
    {
        id: 3,
        column1: "Private Stay (Friends/Families)",
        column2: {
          content: [
            "Your host in Tajikistan must apply for an approval for your Visa to be issued.",
            "AND",
            "A letter of invitation from the Ministry of Foreign Affairs of Tajikistan or Ministry of Interior Affairs.",
        ]
       },
      },
      {
        ...
        column2: {
          content: [
          "A letter to travel to GBAO or Pamir region, for an additional fee of $50.00."
        ]
       },
      },
    {
...

    {
        ...
        column2: {
          content: [
            <a download={true} target='_blank' href={TajikistanVisa}>Download Application Form</a>,
...
const datatable1 = [
['Regular','Single/Double','$30.00/$45.00','5-7 Business Days ','Up to 45 days','30/45 years'],
['Rush','Single/Double','$55.00/$75.00','2-4 Business Days ','Up to 45 days','30/45 years']

];

const datatable2 = [
     ['Regular','$90.00','5-7 Business Days'],
     ['Rush','$140.00','2-4 Business Days'],
];
...
function Tourist_Us_Tajikistan() {
  return (
   <div>
   <div>
    ...
    <center><h3 className='costing-Header'>CONSULAR FEES</h3></center>
      ...
      <h6>The Embassy of Tajikistan is closed on every Friday and does not accept or process any Visa applications on Fridays.</h6>
    </div>
...
export default Tourist_Us_Tajikistan;