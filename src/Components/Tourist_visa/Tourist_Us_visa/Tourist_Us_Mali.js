...
import MaliVisa from "../../../legalizationpdf/MaliVisa.pdf"
  ...
  const tableData = [
    ...
    {
        id: 3,
        column1: "Proof of Invitation",
        column2: {
          content: [
             "For tourism purpose, a hotel confirmation(s) is required.",
             "OR",
             "For family and friends visit, a letter of invitation from the host in Mali is required."
            ]
       },
      },  
      {
...
export default Tourist_Us_Mali;