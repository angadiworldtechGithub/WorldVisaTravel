...
import pdf from "../../../legalizationpdf/WVT-Work-Order.pdf"
  ...
  const tableData = [
    ...
    },
    {
        ...
        column2: {
          content: [
             "To enter Maluku, Poso, and Irian Jaya, travelers have to obtain a permit or authorization from the Department of Foreign Affairs in Jakarta."
          ],
        },
      },
    ...
    
      {
        ...
        column2: {
          content: [
         "Letter of Intent outlining the applicants purpose of travel, length of stay, name of places to be visited, contact information and accommodation information in Indonesia.",
          ],
        },
      },
        ...
        column2: {
          content: [
            "Letter from employer/school confirming leave of absence and vacation dates and that applicant will be",
            "returning to his/her place of employment or school (with I-20 Form if applicable).",
          ],
        },
      },
...

    {
      ...
      column2: {
        content: [
        <a href="https://consular.embassyofindonesia.org/visa/genv/BVV/getstarted.html">Online Application Form</a>,
...
export default Tourist_Us_Indonesia;