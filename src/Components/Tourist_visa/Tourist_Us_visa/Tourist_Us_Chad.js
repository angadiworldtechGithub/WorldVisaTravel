...
import ChadVisa from "../../../legalizationpdf/ChadVisa.pdf"
  ...
  const tableData = [
    ...
    },
    {
        ...
        column2: {
          content: [
             "A business letter from the company is required."
          ],
        },
      },
		
    {
   ...
   
      {
        ...
        column2: {
          content: [
          <a download={true} target='_blank' href={ChadVisa}>Download Visa Application</a>,
...
const datatable1 = [
  ['Regular/Rush/Next Day','Single','$155.00/$180.00/$205.00','1-5 Business Days','Up to 30 days','1 Months'],
  ['Regular/Rush/Next Day','Multiple','$205.00/$230.00/$255.00','1-5 Business Days','Up to 90 days','3 Months'],
  ['Regular/Rush/Next Day','Multiple','$255.00/$280.00/$305.00','1-5 Business Days','Up to 90 days','6 Months'],
...
export default Tourist_Us_Chad;