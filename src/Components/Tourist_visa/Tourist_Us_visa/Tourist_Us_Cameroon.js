...
import CameroonVisaApp_1 from "../../../legalizationpdf/CameroonVisaApp_1.pdf"
  ...
  const tableData = [
      ...
      },
    {
      ...
      column2: {
        content: [
         "A letter of invitation from host in Burundi.",
        ],
      },
    },
    {
      ...
      },
      {
        ...
        column2: {
          content: [
            "1.Acceptance letter from a recognized school in Cameroon.",
            "2.Letter from U.S. school acknowledging the student’s trip to Cameroon and eventually guaranteeing",
            "financial and legal responsibilities for the student while in Cameroon."
          ],
        },
      },
   	...
   	
    {
  ...
  
      {
        ...
        column2: {
          content: [
          <a download={true} target='_blank' href={CameroonVisaApp_1}>Download Visa Application</a>,
...
const datatable1 = [
  ['Regular','Multiple'	,'$186.82/$277.73',	'7-10 Business Days','Up to 30/180 days','6 Months'],
  ['Rush','Multiple','$277.73/$368.64','2-4 Business Days',	'Up to 30/180 days','1 Year'],
];
...
export default Tourist_Us_Cameroon;