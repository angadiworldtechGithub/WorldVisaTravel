...
const datatable1 = [
['Single/Double/Triple','$38.26/$46.57/$63.20','4 Business Days','Up to 30 days/60 days/90 days','6 Months']
];
...
function Tourist_Us_Madagascar() {
  return (
   <div>
   <div>
...
export default Tourist_Us_Madagascar;