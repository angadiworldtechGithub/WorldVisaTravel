...
import CentralAfricanRepublicVisaApp from "../../../legalizationpdf/CentralAfricanRepublicVisaApp.pdf"
  ...
  const tableData = [
    ...
    },
    {
        ...
        column2: {
          content: [
             "A letter of invitation from host in Central African Republic."
          ],
        },
      },
		
    {
   ...
   
      {
        ...
        column2: {
          content: [
          <a download={true} target='_blank' href={CentralAfricanRepublicVisaApp}>Download Visa Applications</a>,
...
const datatable1 = [
  ['Regular/Rush','Multiple','$155.00/$205.00','1-4 Business Days','Up to 90 days','3 Months'],
  ['Regular/Rush','Multiple','	$205.00/$255.00','1-4 Business Days','Up to 90 days','6-12 Months'],
];
...
function Tourist_Us_Centralafrican() {
  return (
   <div>
   <div>
...
export default Tourist_Us_Centralafrican;