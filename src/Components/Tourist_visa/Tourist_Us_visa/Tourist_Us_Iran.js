...
import pdf from "../../../legalizationpdf/WVT-Work-Order.pdf"
  ...
  const tableData = [
    ...
    },
    {
      ...
      column2: {
        content: [
            "One recent professional passport-type photograph. Do NOT staple or glue the photo to the application.",
            "Photos of Muslim age 9 and up must be Islamic cover head (hejab), and Islamic dress code.",
            "Write your name lightly at the back of the photo and use paperclip with the application.",
    ...
    },
    {
        ...
        column2: {
          content: [
            "	Visa Authorization Number from the tour company.",
            ],
        },
      },
...
const datatable1 = [
['Regular','Single/Double','$95.00/$140.00','5-7 Business Days','-','-'],
['Regular','Single/Double','$153.00/$198.00','1-2 Business Days','-','-'],
];
...
export default Tourist_Us_Iran;