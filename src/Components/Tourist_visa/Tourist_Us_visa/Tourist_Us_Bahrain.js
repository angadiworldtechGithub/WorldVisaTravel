...
import BahrainVisa from  "../../../legalizationpdf/BahrainVisa.pdf"
...
const tableData = [
...

    {
      ...
      column2: {
        content: [
         "	A notarized letter of consent approving minor to travel and a copy of both parents’ Passports.",
        ],
      },
    },
...

    {
      ...
      column2: {
        content: [
            ...
            "A letter of intent outlining the applicant’s purpose of travel, length of stay,",
            "name of places to be visited, contact information and accommodation information in Bahrain.",
        ],
      },
    },
...

    {
      ...
      column2: {
        content: [
          <a download={true} target='_blank' href={pdf} >Download Visa Application</a>,
...

    {
      ...
      column2: {
        content: [
          ...
          <a download={true} target='_blank' href={BahrainVisa}>Download here</a>,
...
const datatable1 = [
  ['Multiple','$233.00','2-3 Weeks','Up to 30 days per Entry','5 Years'],
];
...
export default Tourist_Us_Bahrain;