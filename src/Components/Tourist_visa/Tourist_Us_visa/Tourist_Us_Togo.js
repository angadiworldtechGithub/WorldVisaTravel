...
import TogoApplication from "../../../legalizationpdf/TogoApplication.pdf"
import Togo_White_Glove_Form from "../../../legalizationpdf/Togo_White_Glove_Form.pdf"
  ...
  const tableData = [
...

    {
        ...
        column2: {
          content: [
            <a download={true} target='_blank' href={TogoApplication}>Download Application Form</a>,
            "Two completed Visa Applications, MUST be signed.",
            <a download={true} target='_blank' href={Togo_White_Glove_Form}>Download White Glove Form</a>,
            "WVT can help you complete the Togo Visa Application through our White Glove Service (ONLY $55.00).",
        ],
        },
      },
    {
...
const datatable1 = [
['Regular/Rush','Multiple','$145.00/220.00','8-10/4-5 Business Days','Up to 30-90 days','3 Months']

];

const datatable2 = [
     ['Regular','$90.00','4-5 Business Days'],
...
export default Tourist_Us_Togo;