...
import LebanonConsent from "../../../legalizationpdf/LebanonConsent.pdf"
  ...
  const tableData = [
    ...
    },
    {
      ...
      
      {
        ...
        column2: {
          content: [
            <a download={true} target='_blank' href={LebanonConsent}>Download Parental Consent Form</a>,
          "One completed Parental Consent Form, MUST be signed by both parents."],
        },
      }, 
...
export default Tourist_Us_Lebanon;