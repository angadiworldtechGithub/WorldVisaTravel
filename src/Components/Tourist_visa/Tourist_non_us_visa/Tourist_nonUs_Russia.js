...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: ["A standard tourist confirmation from a hosting authorized Russian travel agency or a hotel, registered with the Russian Ministry of Foreign Affairs and a voucher from your hotel or travel agency in Russia.",
    "The confirmation must contain the agency’s reference number and registration number.",
"World Visa Travel is partnered with a Russian Host, which can help you to get a Visa Support Letter for only $50.00 in 24 hours turnaround time. For Tourist Visa inquiries only. Applicable to certain countries.Please call for more information.",
...
<a download={true} target='_blank' href={Russian_Visa_Support_Form}>Russian Visa Support Questionnaire</a>,
  ...
  },
  {
    ...
    column2: {
      content: ["	Documents supporting loss of citizenship."],
    },
  },
  {
    id: 6,
    ...
    column2: {
      content: ["	A copy of your Soviet or Ukrainian Passport.A letter stating when you immigrated to the United States."],
    },
  },
  {
    id: 7,
  ...
  },
  {
    ...
    column2: {
      content: [
        ...
        <a download={true} target='_blank' href={Russian_Visa_White_Glove_Form}>Russian White Glove Form</a>,
        "Please call for further assistance.",
        <a download={true} target='_blank' href={"https://visa.kdmid.ru/PetitionChoice.aspx"}>Online Application Form</a>,
...
const datatable1 = [
  ["Regular/Rush","Single/Double","$93.00/$93.00", "7-9 Business Days", "Up to 30 days","-"],
  ["Rush","Single/Double","$173.00/$173.00", "3-5 Business Days", "Up to 30 days","-"],
  ["Emergency","Single/Double","$238.00/$238.00", "1-2 Business Days", "Up to 30 days","-"],
  
];
const datatable2 = [
    ["Regular/Rush","Single/Double","$133.00/$187.00", "7-9 Business Days", "Up to 30 days","-"],
    ["Rush","Single/Double","$253.00/$361.00", "3-5 Business Days", "Up to 30 days","-"],
    ["Emergency","Single/Double","$263.00/$421.00", "1-2 Business Days", "Up to 30 days","-"],
...
function Tourist_nonUs_Russia() {
  return (
    <div>
      ...
      <div className="req-table-container">
        <center>
          <h3 className="costing-Header">CONSULAR FEES (EU NATIONALITIES)</h3>
        </center>
        ...
        <h6>Citizens of Denmark, Ireland and Great Britain follow the fees below.</h6>
...
export default Tourist_nonUs_Russia;