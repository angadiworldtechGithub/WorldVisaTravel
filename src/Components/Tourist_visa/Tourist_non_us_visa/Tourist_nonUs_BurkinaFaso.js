...
const tableData = [
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={BFA_Visa}>Download Visa Application</a>,
...
const datatable1 = [
  ['Regular', 'Single/Multiple', '$110.00/$140.00', '3-4 Business Days', 'Up to 30 days', '3 Months'],
  ['Regular', 'Single/Multiple', '$150.00/$180.00', '3-4 Business Days', 'Up to 30 days', '6 Months'],
  ['Regular', 'Single/Multiple', '$195.00/$225.00', '3-4 Business Days', 'Up to 30 days', '1 year'],
  ['Rush', 'Single/Multiple', '$160.00/$190.00', '1-2 Business Days', 'Up to 30 days', '3 Months'],
  ['Rush', 'Single/Multiple', '$200.00/$230.00', '1-2 Business Days', 'Up to 30 days', '6 Months'],
  ['Rush', 'Single/Multiple', '$245.00/$275.00', '1-2 Business Days', 'Up to 30 days', '1 year'],

];

const datatable2 = [
  ['Regular', '$90.00', '10 Business Days'],
  ['Rush', '$140.00', '4 Business Days'],
];
...
function Tourist_nonUs_BurkinaFaso() {
  return (
    <div>
      <div>
...
export default Tourist_nonUs_BurkinaFaso;