...
import Oman_Visa_Application from "../../../legalizationpdf/Oman_Visa_Application.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: ["	A letter indicating the purpose of your trip, name of hotel you will be staying in, the dates of your planned trip, and places to be visited."],
    },
  },
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={Oman_Visa_Application}>Online Application Form</a>,
        "One completed Visa Application, MUST be printed and signed for each copy.",
        "Note: “Sponsor Details” must be filled in to complete this form. If you do not have a sponsor, or do not know the details, please fill in the applicant’s information and enter “Myself” for the sponsor relationship." ,     ],
    },
  },
...
const datatable1 = [
    ["Single","$95.00", "More than 10 Business Days", "Up to 30 days","Up to 3 Months"],
    
  ];

const datatable2 = [
  ["Regular","$90.00", "More than 10 Business Days"],
...
export default Tourist_nonUs_Oman;