...
const tableData = [
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={"https://formulario-mre.serpro.gov.br/sci/pages/web/ui/#/cidadao-nacionalidade"}>Download here</a>,
...
export default Tourist_nonUs_Brazil;