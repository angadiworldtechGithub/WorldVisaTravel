...
const datatable1 = [
  ['Single', '$45.00/ $65.00/ $75.00', '7-10 Business Days', 'Up to 30 days', '1 Month/ 3 Months'],
  ['Multiple', '$85.00', '7-10 Business Days', 'Up to 30 days', '6 Months'],
]
const datatable2 = [
...
function Tourist_nonUs_Ethiopia() {
  return (
    <div>
      <div>
...
export default Tourist_nonUs_Ethiopia;