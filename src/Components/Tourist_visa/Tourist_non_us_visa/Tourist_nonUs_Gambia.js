...
import GambiaNonUSVisaApp from "../../../legalizationpdf/GambiaNonUSVisaApp.pdf";
const tableData = [
    {
        id: 1,
        column1: "Passport",
    ...
    },
    {
        ...
        column2: {
            content: [
                <a download={true} target='_blank' href={GambiaNonUSVisaApp}>Download Visa Application</a>,
...
const datatable1 = [
    ['Regular', 'Single/ Multiple', '$205.00', '10 Business Days', 'Up to 90 days', '3 Months'],
    ['Rush', 'Single/ Multiple', '$255.00', '3 Business Days', 'Up to 90 days', '3 Months'],
    ['Emergency', 'Single/ Multiple', '$280.00', '24 Hours', 'Up to 90 days', '3 Months'],
]
const datatable2 = [
    ['Regular', '$90.00', '10 Business Days'],
    ['Rush', '$140.00', '3 Business Days'],
    ['Emergency', '$170.00', '24 Hours'],
];
...
export default Tourist_nonUs_Gambia;