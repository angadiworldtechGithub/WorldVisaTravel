...
import MyanmarTouristApplication from "../../../legalizationpdf/MyanmarTouristApplication.pdf";
...
const tableData = [
    ...
    },
    {
        ...
        column2: {
            content: [
                <a download={true} target='_blank' href={MyanmarTouristApplication}>Download Application Form</a>,
...
const datatable1 = [
    ['Single','$45.00', '7-10 Business Days', 'Up to 28 days', '3 Months'],
...
function Tourist_nonUs_Myanmar() {
    return (
        <div>
            <div>
...
export default Tourist_nonUs_Myanmar;