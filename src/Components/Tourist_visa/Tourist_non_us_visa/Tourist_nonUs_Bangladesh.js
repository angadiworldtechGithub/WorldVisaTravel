...
const tableData = [
...

  {
    ...
    column2: {
      content: [
        "A letter of invitation from host in Bangladesh is required.",
      ],
    },
  },
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={"https://www.visa.gov.bd/"}>Online Application Form</a>,
...
function Tourist_nonUs_Bangladesh() {
  return (
    <div>
      <div>
...
export default Tourist_nonUs_Bangladesh;