...
import PhilippinesVisa1 from "../../../legalizationpdf/PhilippinesVisa1.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={PhilippinesVisa1}>Download Application Form</a>,
...
const datatable1 = [
  ["Single/Multiple/Multiple","$45.00/$85.00//$125.00", "6-8 Business Days", "Up to 59 days","3 Months/6 Months/1 Year"],
...
function Tourist_nonUs_Philipians() {
  return (
    <div>
      <div>
...
export default Tourist_nonUs_Philipians;