...
const tableData = [
    ...
    {
        id: 5,
        column1: "Restricted Regions",
        column2: {
            content: [
                "To enter Maluku, Poso, and Irian Jaya, travelers have to obtain a permit or authorization",
                "from the Department of Foreign Affairs in Jakarta.",
            ],
        },
    },
    {
        ...
        column2: {
            content: [
                "Letter of Intent outlining the applicants purpose of travel, length of stay, name of places to be visited,",
                "contact information and accommodation information in Indonesia.",
            ],
        },
    },
    ...
    {
        id: 5,
        column1: "Letter of Notice",
        column2: {
            content: [
                "Letter from employer/school confirming leave of absence and vacation dates and that applicant will be returning to his/her place of employment or school (with I-20 Form if applicable).",
            ],
        },
    },
    {
...

    {
        ...
        column2: {
            content: [
                <a download={true} target='_blank' href={"https://consular.embassyofindonesia.org/visa/genv/BVV/getstarted.html"}>Online Application Form</a>,
...
const datatable1 = [
['Single/Multiple', '$55.00/$115.00', '4 Business Days', 'Up to 60 days', '3 Months/ 1 Year'],

]
const datatable2 = [
    [ '$90.00', '4 Business Days'],
...
function Tourist_nonUs_Indonesia() {
    return (
        <div>
            <div>
...
export default Tourist_nonUs_Indonesia;