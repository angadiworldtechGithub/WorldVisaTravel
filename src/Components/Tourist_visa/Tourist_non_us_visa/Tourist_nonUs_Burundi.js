...
const tableData = [
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={BurundiVisa}>Download Visa Application</a>,
...
const datatable1 = [
  ['Single/Multiple', '$95.00/$185.00/$275.00', '15 Business Days', 'Up to 30-90 days', '1-3 Months'],
];



const datatable3 = [
  ['$90.00', '15 Business Days'],
...
function Tourist_nonUs_Burundi() {
  return (
    <div>
      <div>
...
export default Tourist_nonUs_Burundi;