...
const tableData = [
    ...
    },
    {
        ...
        column2: {
            content: [
                <a download={true} target='_blank' href={GeorgiaVisa}>Download Regular Application Form</a>,
...
const datatable2 = [
    ['Regular', '$90.00', '5-15 Business Days'],
...
function Tourist_nonUs_Georgia() {
    return (
        <div>
            <div>
...
export default Tourist_nonUs_Georgia;