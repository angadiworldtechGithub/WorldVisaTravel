...
import CameroonVisaApp_1 from "../../../legalizationpdf/CameroonVisaApp_1.pdf";
...
const tableData = [
...

  {
    ...
    column2: {
      content: [
        "A letter of invitation from host in Cameroon.",
      ],
    },
  },
  ...
  {
    id: 6,
    column1: "Student Visa",
    column2: {
      content: [
        "Acceptance letter from a recognized school in Cameroon.",
        "Letter from U.S. school acknowledging the student’s trip to Cameroon and eventually guaranteeing financial and legal responsibilities for the student while in Cameroon.",
      ],
    },
  },
  {
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={CameroonVisaApp_1}>Download Application Form</a>,
...
const datatable1 = [
  ['Regular/Rush', 'Multiple', '	$186.82/ $277.73', '	7-10 Business Days', 'Up to 30/ 180 days', '6 Months'],
  ['Regular/Rush', 'Multiple', '	$277.73/ $368.64', '	2-4 Business Days', 'Up to 30/ 180 days', '1 Year']
]
const datatable2 = [
  ['$120.00', '7-10 Business Days'],
  ['$170.00', '2-4 Business Days'],
...
function Tourist_nonUs_Cameroon() {
  return (
    <div>
      <div>
      ...
      <div className="req-table-container">
        ...
        <div className='Detailsdata_descripition'>
          ...
          <br></br>
          <h6>The Embassy of Cameroon will not allow submitted Passport/Application to be cancelled or withdrawn until the process is completed.</h6>
        </div>
...
export default Tourist_nonUs_Cameroon;