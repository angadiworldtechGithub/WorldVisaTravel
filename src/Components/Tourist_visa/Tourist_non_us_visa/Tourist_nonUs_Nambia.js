...
import NamibiaVisa from "../../../legalizationpdf/NamibiaVisa.pdf";
...
const tableData = [
    ...
    },
    {
        ...
        column2: {
            content: [
                <a download={true} target='_blank' href={NamibiaVisa}>Download Application Form</a>,
...
const datatable1 = [
    ['Regular', 'Single/ Multiple', '$55.00/ $105.00', '6-8 Business Days'],
    ['Rush', 'Single/ Multiple', '$55.00/ $105.00', '3-5 Business Days'],

]
const datatable2 = [
    ['Regular', '$90.00', '6-8 Business Days'],
...
export default Tourist_nonUs_Nambia;