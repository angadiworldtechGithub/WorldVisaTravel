    ...
    },
    {
        ...
        column2: {
            content: [
                ...
                "One completed Visa Application, MUST be signed. Application can be filled electronically or with Black INK only, in BLOCK / CAPITAL letters.",
...
export default Tourist_nonUs_Ghana;