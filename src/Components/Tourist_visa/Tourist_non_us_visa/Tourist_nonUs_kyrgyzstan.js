...
const tableData = [
...

    {
        ...
        column2: {
            content: [
                <a download={true} target='_blank' href={KyrgyzstanVisa}>Download Visa Application</a>,
...
const datatable1 = [
    ['Regular/ Rush','Single/ Double', '$105.00/ $120.00/ $205.00/ $235.00', '3-12 Business Days', '-', '1-3 Months'],
...
function Tourist_nonUs_kyrgyzstan() {
    return (
        <div>
            <div>
...
export default Tourist_nonUs_kyrgyzstan;