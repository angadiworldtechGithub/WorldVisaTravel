...
const tableData = [
...

    {
        ...
        column2: {
            content: [
                <a download={true} target='_blank' href={TurkmenistanVisa}>Download Application Form</a>,
...
const datatable3 = [
    ['Regular','Multiple', '$80.00/ $120.00/ $160.00/ $200.00/ $240.00/ $280.00/ $320.00/ $360.00/ $400.00/ $440.00/ $480.00/ $520.00', '7-10 Business Days','Up to 10/ 20/ 30/ 60/ 90/ 120/ 150/ 180/ 210/ 240/ 270/ 300/ 330/ 365 Days'],
    ['Rush','Multiple', '$140.00/ $220.00/ $300.00/ $380.00/ $460.00/ $540.00/ $620.00/ $700.00/ $780.00/ $860.00/ $940.00/ $1020.00', '2-3 Business Days','Up to 10/ 20/ 30/ 60/ 90/ 120/ 150/ 180/ 210/ 240/ 270/ 300/ 330/ 365 Days'],
...
function Tourist_nonUs_Turkmenistan() {
    return (
        <div>
            <div>
...
export default Tourist_nonUs_Turkmenistan;