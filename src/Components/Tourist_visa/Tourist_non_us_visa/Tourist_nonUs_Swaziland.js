...
import SwazilandVisa from "../../../legalizationpdf/SwazilandVisa.pdf";
  ...
  const tableData = [
    ...
    
    {
      ...
      column2: {
        content: [
          "A letter of invitation from host organization in Swaziland.          ",
        ],
      },
    },
...

    {
      ...
      column2: {
        content: [
          <a download={true} target='_blank' href={SwazilandVisa}>Download Application Form</a>,
...
const datatable1 = [
  ['Single', '$15.00', '4 Business Days' ,'Up to 60 days', '3 Months'],
  ['Multiple', '$45.00/ $95.00/ $135.00/ $175.00', '4 Business Days' ,'Up to 60 days', '3 Months/ 6 Months/ 9 Months/ 1 Year'],
...
function Tourist_nonUs_Swaziland() {
  return (
   <div>
   <div>
...
export default Tourist_nonUs_Swaziland;