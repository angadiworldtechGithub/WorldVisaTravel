...
const datatable1 = [
    ['Single/ Double/ Triple', '$38.26/ $46.57/$63.20', '4 Business Days', 'Up to 30/60/90 days', '6 Months'],
...
function Tourist_nonUs_Madagascar() {
    return (
        <div>
            <div>
...
export default Tourist_nonUs_Madagascar;