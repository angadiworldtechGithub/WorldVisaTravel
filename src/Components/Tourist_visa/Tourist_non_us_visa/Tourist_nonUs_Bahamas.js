...
import BahamasVisa from "../../../legalizationpdf/BahamasVisa.pdf";
...
const tableData = [
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={BahamasVisa}>Download Visa Application</a>,
...
const datatable1 = [
  [ '$105.00', '5 Business Days', 'Up to 30-90 days', '3 Months'],
...
function Tourist_nonUs_Bahamas() {
  return (
    <div>
      <div>
...
export default Tourist_nonUs_Bahamas;