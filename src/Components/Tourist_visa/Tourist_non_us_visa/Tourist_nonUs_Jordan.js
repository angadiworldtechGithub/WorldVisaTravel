...
import JordanVisa from "../../../legalizationpdf/JordanVisa.pdf";
...
const tableData = [
...

    {
        ...
        column2: {
            content: [
                <a download={true} target='_blank' href={JordanVisa}>Download Application Form</a>,
...
const datatable1 = [
    ['Single', '$65.00/ $72.00', '2-4 Business Days', 'Up to 30 days', '1 Month/ 2 Months'],
    ['Double', '$95.00/ $102.00', '2-4 Business Days', 'Up to 30 days', '1 Month/ 2 Months'],
    ['Multiple', '$192.00', '2-4 Business Days', 'Up to 30 days', '1 Month/ 2 Months'],
]
const datatable2 = [
    ['Regular/Rush','Single/Double/Multiple','$90.00/ $140.00', '2-4 Business Days'],
...
export default Tourist_nonUs_Jordan;