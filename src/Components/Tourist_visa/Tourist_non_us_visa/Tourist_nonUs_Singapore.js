...
import SingaporeVisa1 from "../../../legalizationpdf/SingaporeVisa1.pdf";
  ...
  const tableData = [
...

    {
      ...
      column2: {
        content: [
          <a download={true} target='_blank' href={SingaporeVisa1}>Download Application Form</a>,
...
const datatable1 = [
  ['Single', '$28.00', '2-4 Weeks' ,'Up to 30 days'],
...
function Tourist_nonUs_Singapore() {
  return (
   <div>
   <div>
...
export default Tourist_nonUs_Singapore;