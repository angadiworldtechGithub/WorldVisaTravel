...
const tableData = [
  ...
  
    {
        ...
        column2: {
            content: [
                "A letter of invitation from host in Georgia.",
            ],
        },
    },
    {
        ...
        column2: {
            content: [
                "A copy of the host’s residential status in Malawi (e.g. Permit or Malawi Passport if Malawian).",
            ],
        },
    },
    {
...
export default Tourist_nonUs_Malawi;