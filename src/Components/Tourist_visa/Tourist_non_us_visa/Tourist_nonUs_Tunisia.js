...
import TunisiaVisa from "../../../legalizationpdf/TunisiaVisa.pdf";
...
const tableData = [
...

    {
        ...
        column2: {
            content: [
                <a download={true} target='_blank' href={TunisiaVisa}>Download Application Form</a>,
...
const datatable1 = [
    ['Single', '$21.00/$61.00', '5-15 Business Days','5-7 Days/ 7+ days', 'Determined by Itinerary'],
   ]
const datatable2 = [
...
function Tourist_nonUs_Tunisia() {
    return (
        <div>
            <div>
...
export default Tourist_nonUs_Tunisia;