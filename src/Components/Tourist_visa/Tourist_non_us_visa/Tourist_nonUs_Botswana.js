...
import BotswanaVisa from "../../../legalizationpdf/BotswanaVisa.pdf"
const tableData = [
  {
    id: 1,
    column1: "Passport",
...

  {
    ...
    column2: {
      content: [
        "A letter authorizing whoever will be collecting their Visa and Passports, including their full name,",
        "ID or Passport numbers and contact numbers to the Embassy.",
      ],
    },
  },
...

  {
    ...
    column2: {
      content: [
        ...
        <a download={true} target='_blank' href={BotswanaVisa}>Download here</a>,
...
const datatable1 = [
  ['Single', '$112.00', '21 Business Days', 'Up to 30 days'],
 

];

const datatable2 = [
  ['$90.00', '21 Business Days'],
...
function Tourist_nonUs_Botswana() {
  return (
    <div>
      <div>
...
export default Tourist_nonUs_Botswana;