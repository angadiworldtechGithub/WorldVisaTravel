...
import TaiwanAuthorization from "../../../legalizationpdf/TaiwanAuthorization.pdf";
...

    {
        ...
        column2: {
            content: [
                ...
                <a download={true} target='_blank' href={TaiwanAuthorization}>Print Authorization Letter</a>,
                "One completed Authorization Letter, MUST be printed and signed.",
            ],
        },
    },
...
const datatable1 = [
    ['Regular/ Rush', 'Multiple', '$150.00/ $200.00', '1-2/ 4 Business Days', 'Up to 60 days', '5 Years'],

]
const datatable2 = [
    ['Regular', '$80.00', '4 Business Days'],
    ['Rush', '$115.00', '1-2 Business Days'],
...
export default Tourist_nonUs_Taiwan;