...
import ThaiVisaApplication from "../../../legalizationpdf/ThaiVisaApplication.pdf";
...
const tableData = [
...

    {
        ...
        column2: {
            content: [
                "Single Entry:",
               " A copy of your recent bank statement or evidence of adequate finance, such as a letter from a bank showing at least $700.00/person and $1,500.00/family.",
                "Multiple Entry:",
                "A copy of bank statement or evidence of adequate finance for the last 6 months with a minimum balance of $7,000.00.",
            ],
        },
    },
...

    {
        ...
        column2: {
            content: [
                <a download={true} target='_blank' href={ThaiVisaApplication}>Download Application Form</a>,
...
const datatable1 = [
    ['Single/ Multiple','$45.00/ $205.00', '4 Business Days','Up to 60 days', '3 Months/ 6 Months'],
...
function Tourist_nonUs_Thailand() {
    return (
        <div>
            <div>
...
export default Tourist_nonUs_Thailand;