...
import QatarVisa from "../../../legalizationpdf/QatarVisa.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: ["A letter of invitation from host in Qatar.	"],
    },
  },
  {
    id: 7,
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={QatarVisa}>Download Application Form</a>,
...
const datatable1 = [
  ["Multiple","$165.00", "7-10 Business Days","Up to 30 days","1-10 Years"],
...
export default Tourist_nonUs_Qatar;