...
import NicaraguaVisa from "../../../legalizationpdf/NicaraguaVisa.pdf";
...
const tableData = [
    ...
    },
    {
        ...
        column2: {
            content: [
                <a download={true} target='_blank' href={NicaraguaVisa}>Download Application Form</a>,
...
const datatable1 = [
    ['Single','$40.00', '1-3 Business Days','-', '1 Month'],
...
function Tourist_nonUs_Nicaragua() {
    return (
        <div>
            <div>
            ...
            <div className="req-table-container">
                ...
                <div className='Detailsdata_descripition'>
                    ...
                    <br></br>
                    <h6>For some Nationalities that require an approval from Nicaragua, processing time may take up to 2 weeks or more.</h6>
                     </div>
...
export default Tourist_nonUs_Nicaragua;