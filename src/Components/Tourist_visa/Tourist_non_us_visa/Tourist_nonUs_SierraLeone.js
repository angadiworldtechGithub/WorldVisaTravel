...
import Sierra_Leone_Application from "../../../legalizationpdf/Sierra_Leone_Application.pdf";
  ...
  const tableData = [
    ...
    },
    {
      ...
      column1: "Photo",
      column2: {
        content: ["One passport-type photographs.",<a href='https://travel.state.gov/content/travel/en/passports/how-apply/photos.html' target="_blank" >Quality Requirements for Passport Book & Passport Card Photographs</a>],
...

    {
      ...
      column2: {
        content: [
          <a download={true} target='_blank' href={Sierra_Leone_Application}>Download Application Form</a>,
...
const datatable1 = [
  ['Regular','Multiple', '$45.00/ $85.00', '5 Business Days' ,'Up to 30 days', '6 Months/ 1 Year'],
  ['Rush','Multiple', '$95.00/ $135.00', '1-2 Business Days' ,'Up to 30 days', '6 Months/ 1 Year'],
...
const datatable4 = [
  ['Regular','Multiple', '$77.00/ $149.00', '5 Business Days' ,'Up to 30 days', '6 Months/ 1 Year'],
  ['Rush','Multiple', '$127.00/ $199.00', '1-2 Business Days' ,'Up to 30 days', '6 Months/ 1 Year'],

];

const datatable5 = [
  ['Regular','Multiple', '$142.00/ $436.00', '5 Business Days' ,'Up to 30 days', '6 Months/ 1 Year'],
  ['Rush','Multiple', '$192.00/ $486.00', '1-2 Business Days' ,'Up to 30 days', '6 Months/ 1 Year'],

];

function Tourist_nonUs_SierraLeone() {
  return (
   <div>
   <div>
...
export default Tourist_nonUs_SierraLeone;