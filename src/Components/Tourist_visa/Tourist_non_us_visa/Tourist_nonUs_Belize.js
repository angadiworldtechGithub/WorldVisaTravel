...
import BelizeVisa from "../../../legalizationpdf/BelizeVisa.pdf";
...
const tableData = [
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={BelizeVisa}>Dow;
    nload Visa Application</a>,
...
export default Tourist_nonUs_Belize;