...
import SudanVisa from "../../../legalizationpdf/SudanVisa.pdf";
  ...
  const tableData = [
...

    {
        ...
        column2: {
          content: [
            "A Visa Approval from the Tourist_nonUs_Sudan Ministry of Foreign Affairs.            ",
...
const datatable1 = [
  ['Single', '$159.00', '4-6 Weeks' ,'Up to 30 days', '3 Months'],
...
export default Tourist_nonUs_Sudan;