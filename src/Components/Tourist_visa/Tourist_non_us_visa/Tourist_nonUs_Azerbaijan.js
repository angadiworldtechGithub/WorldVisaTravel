...
const tableData = [
    ...
    {
        id: 4,
        column1: "Tourist Voucher",
        column2: {
            content: [
                "A copy of tourist voucher from the Travel or Tour Agency in Azerbaijan that made your travel reservations",
                "If you did not use an Azerbaijan based agency for your booking, please see the requirements for",
                "obtaining an Azerbaijan Tourist – Without Voucher Visa – Non-U.S. Citizens.",
            ],
        },
    },
...
function Tourist_nonUs_Azerbaijan() {
    return (
        <div>
            <div>
...
export default Tourist_nonUs_Azerbaijan;