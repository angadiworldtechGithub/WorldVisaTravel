...
const tableData = [
    ...
    },
    {
        ...
        column2: {
            content: [
                <a download={true} target='_blank' href={CapeVerdeVisa}>Download Visa Application</a>,
...
const datatable1 = [
    ['Single/Multiple', '$165.00/ $199.00', '3 Business Days', 'Up to 30-90 days', '3 Months/ 5 years'],
...
function Tourist_nonUs_CapeVarde() {
    return (
        <div>
            <div>
...
export default Tourist_nonUs_CapeVarde;