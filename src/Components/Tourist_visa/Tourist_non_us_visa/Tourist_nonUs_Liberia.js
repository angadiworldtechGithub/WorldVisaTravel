...
const tableData = [
...

    {
        ...
        column2: {
            content: [
                "A notarized letter of consent from the parents or guardian as well as a copy of the birth certificate of the minor is required.",
            ],
        },
    },
...
const datatable1 = [
    ...
    ['Same Day','Single/ Multiple', '$150.00/ $230.00/ $330.00', 'Same day', 'Up to 30 days', '3 Months/ 1 Year/ 2 Years'],
]
const datatable2 = [
...
function Tourist_nonUs_Liberia() {
    return (
        <div>
            <div>
...
export default Tourist_nonUs_Liberia;