...
import Visitors_Visa_Application_Form_DHA_84_Form_11_June_19_2014 from "../../../legalizationpdf/Visitors_Visa_Application_Form_DHA_84_Form_11_June_19_2014.pdf";
  ...
  const tableData = [
      ...
      },
    {
      ...
      column2: {
        ...
        "Copy of bio-page of passport is needed. This copy must be NOTARIZED.        "
    ],
      },
    },
    {
...

    {
      ...
      column2: {
        content: [
          "A copy of evidence of legal status in the U.S. This copy must be NOTARIZED.          ",
        ],
      },
    },
...

    {
...

      {
        ...
        column2: {
          content: [
            "A person under 18 years of age not traveling with both parents or legal guardian(s) must provide a letter of consent signed by the non-accompanying parent(s) or guardian.            ",
          "A copy of the minor’s birth certificate is also required and must be NOTARIZED.          "],
        },
      },
...

    {
      ...
      column2: {
        content: [
          "One completed Visa Application, MUST be signed. Must be written in BLACK Ink.          ",
        ],
      },
    },

    {
      ...
      column2: {
        content: [
          <a download={true} target='_blank' href={Visitors_Visa_Application_Form_DHA_84_Form_11_June_19_2014}>Download Application Form</a>,
...
function Tourist_nonUs_SouthAfrica() {
  return (
   <div>
   <div>
...
export default Tourist_nonUs_SouthAfrica;