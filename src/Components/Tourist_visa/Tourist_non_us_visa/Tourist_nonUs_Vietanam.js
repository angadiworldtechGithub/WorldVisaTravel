...
import azerbaijan_Visa_Application_Form from "../../../legalizationpdf/azerbaijan_Visa_Application_Form.pdf";
...
const tableData = [
...

    {
        ...
        column2: {
            content: [
                <a  target='_blank' href={"https://visa.mofa.gov.vn/_layouts/registration/ApplicationForm.aspx"}>Online Application Form</a>,
...
const datatable1 = [
    ['Regular', 'Single', '$75.00/ $105.00', '2-3 Business Days', 'Up to 30/ 90 days', '1 Month/ 3 Months'],
    ['Regular', 'Multiple', '$130.00/ $155.00', '2-3 Business Days', 'Up to 30/ 90 /180 days', '1 Month/ 3 Months/ 6 Months'],
    ['Same Day', 'Single', '$125.00/ $155.00', 'Same Day', 'Up to 30/ 90 days', '1 Month/ 3 Months'],
    ['Same Day', 'Multiple', '$180.00/ $205.00/ $220.00', 'Same Day', 'Up to 30/ 90 days', '1 Month/ 3 Months/ 6 Months'],

]
const datatable2 = [
    ['Regular', '$80.00', '2-3 Business Days'],
    ['Emergency', '$15.00', '24 Hours'],
...
function Tourist_nonUs_Vietanam() {
    return (
        <div>
            <div>
...
export default Tourist_nonUs_Vietanam;