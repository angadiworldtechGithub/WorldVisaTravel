...
import NigeriaWhiteGlove from "../../../legalizationpdf/NigeriaWhiteGlove.pdf";
...
const tableData = [
...

    {
        ...
        column2: {
            content: [
                "If traveler is staying in a private home, a letter of invitation from host is required.",
                "If the traveler’s host is a Nigerian Citizen, a copy of his/her Nigerian Passport",
                "(first four pages) is required.",
                "If the traveler’s host is not a Nigerian Citizen, a copy of their resident permits and",
                "the information pages on his/her Passport(s) is required.",
            ],
        },
    },
    {
...
<a download={true} target='_blank' href={NigeriaWhiteGlove}>Nigeria White Glove Form</a>,
"Please call for further assistance.",
<a target='_blank' href={"https://portal.immigration.gov.ng/visa/freshVisa"}>Online Application Form</a>,
...
const datatable2 = [
    [ 'Regular','Single/ Multiple','$270.00', '8-10 Business Days','Up to 90 days','3-12 Months'],
...
function Tourist_nonUs_Nigeria() {
    return (
        <div>
            <div>
...
export default Tourist_nonUs_Nigeria;