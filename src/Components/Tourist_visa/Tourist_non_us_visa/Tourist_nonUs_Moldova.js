...
import MoldovaVisa from "../../../legalizationpdf/MoldovaVisa.pdf";
...
const tableData = [
  ...
  
    {
        ...
        column2: {
            content: [
                "For citizens of Israel and Turkey, applying for a 6 and 12 months Visa, a letter of invitation from host or organization is required.",
    ...
    },
    {
        ...
        column2: {
            content: [
                <a download={true} target='_blank' href={MoldovaVisa}>Download Application Form</a>,
...
const datatable1 = [
    ...
    ['Regular/ Rush','Single', '$60.00/ $85.00', '1-5 Business Days',  '1 Month'],
    ['Regular/ Rush','Single', '$80.00/ $115.00', '1-5 Business Days',  '1 Month'],
    ['Regular/ Rush','Single', '$110.00/ $160.00', '1-5 Business Days',  '2 Months'],
    ['Regular/ Rush','Single', '$130.00/ $190.00', '5 Business Days',  '3 Months'],
    ['Regular/ Rush','Single', '$170.00/ $250.00', '5 Business Days',  '6 Months'],
    ['Regular/ Rush','Single', '$210.00/ $310.00', '1 Year',  '5 Business'],

]
const datatable2 = [
    ['Regular', '$90.00', '5 Business Days'],
    ['Rush', '$140.00', '1-2 Business Day(s)'],
...
function Tourist_nonUs_Moldova() {
    return (
        <div>
            <div>
...
export default Tourist_nonUs_Moldova;