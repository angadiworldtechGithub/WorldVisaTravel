...
import "./Replace.css"; // Create a CSS file for styling
import Renewtable from "../Renewtable/Renewtable";
...
const ReqdoumentsTable = () => {
  const tableData = [
   ...
   {
    id: 5,
    column1: "Mutilated/Damaged Passport",
    column2: {
      content: [
        "Previous mutilated or damaged passport is required.",
      ],
  },
 },
  ...
  return (
    <div className="reqdouments">
      <center className="reqdouments-header">
        <h3 className='costing-Header'>REPLACE A MUTILATED OR DAMAGED U.S. PASSPORT</h3>
