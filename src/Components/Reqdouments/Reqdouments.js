  ...
  return (
    <div className="reqdouments">
      ...
      <div className="reqdouments-passage-list">
        ...
        <ol>
          <h5><b>Go to U.S. Passport Applications and Forms</b></h5>
          <li>
            Check the <b>Privacy and Computer Fraud and Abuse Acts Notices and
            Disclaimers</b> and Click “Submit”.
          </li>
          <li>Choose “Complete Form Online” and Click “Submit”.</li>
          <li>In the <b>About the Applicant</b> page,</li>
          <ul>
            <li>
              Check the <b>Privacy Act and Paperwork Reduction Act statements</b> and
              Fill Out the necessary fields
            </li>
            <li>Click “Next” when done</li>
          </ul>
          <li>In the <b>Contact Information</b> page,</li>
          <ul>
            <li>Fill Out the necessary fields</li>
            <li>Choose “Yes” for <b>Permanent Address</b></li>
            <li>Choose “Mail” for <b>Preferred Method of Communication</b></li>
            <p>
              <b>Note : </b>We will deliver your Passport to your desired address. The
              information here is only for application purpose.
            </p>
            <li>Click “Next” when done</li>
          </ul>
          <li>In the<b> Travel Plans</b> page,</li>
          <ul>
            <li>
            ...
            <li>
              ...
              <h6>Enter Date Of Your Return: August 28, 2015 (you
              may enter any date of return)</h6>
              <p>Remember to provide an itinerary
        ...
        <ol>
          ...
          <li>
            For <b>Countries To Be Visited,</b> Enter any country. (e.g. CANADA,
            MEXICO, etc.)
          </li>
          <ul>
            <li>
          ...
          <li>In <b>Who should we contact in case of an emergency?</b> page,</li>
          <ul>
            <li>Fill Out all fields</li>
            <li>Click “Next” when done</li>
          </ul>
          <li>In <b>Your Most Recent Passport</b> page,</li>
          <ul>
            <li>Choose “None”</li>
            <li>Click “Next” when done</li>
          </ul>
          ...
          <li>In <b>Are you known by other names? </b>page,</li>
          <ul>
            <li>Fill Out if applicable</li>
            <li>Click “Next” when done</li>
          </ul>
          <li>In <b>Personal Application Review</b> page,</li>
          <ul>
          ...
          <li>In <b>Passport Products and Fees</b> page,</li>
          <ul>
        ...
        <ul>
          ...
          <li><b>In <b>Next Steps </b>page,</b></li>
          <ul>
            <li>
              Check <b>I have read and acknowledge the steps and information
              contained above.</b>
            </li>
          ...
          <ul>
            ...
            <p><b>Printing Instructions: </b>Please print this
              form on <b>SINGLE-SIDED PAPER </b> – double-sided printing will not be
          ...
          <ul>
            ...
            <li>
              Please send <b>all Required Documents</b> to us Same Day/Next Day after
              it is signed
            </li>
          </ul>
        </ol>
