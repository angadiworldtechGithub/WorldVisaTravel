...
import './Newpassporttable.css'; // Make sure to create this CSS file


const datatable1 = [
  ['Regular',	'$135.00','8-10 Weeks'],
  [ 'Expedited','$195.00','4-6 Weeks'] ,   
  ['Rush','$195.00','2-3 Weeks'],
  ['Priority','$195.00','7-10 Business Days'],
];
...
export default Newpassporttable;
