...
import BoliviaWhiteGlove from "../../../legalizationpdf/BoliviaWhiteGlove.pdf";
const tableData = [
  {
    id: 1,
    column1: "Passport",
  ...
  },
  {
    ...
    column2: {
      content: ["	A copy of your recent bank statement or evidence of adequate finance, such as a letter from a bank."],
    },
  },
  {
    id: 7,
    column1: "Good Conduct Certificate",
    column2: {
      content: ["A Good Conduct Certificate from local Police Department."],
    },
  },
  {
    id: 8,
  ...
  },
  {
    ...
    column2: {
      content: [
        "	WVT can help you complete the Bolivia Visa Online Application through our White Glove Service (ONLY $50.00).",
        <a download={true} target='_blank' href={BoliviaWhiteGlove}>Bolivia White Glove Form</a>,
        "Please call for further assistance.",
        <a href="https://www.rree.gob.bo/formvisas/inicioformulario.aspx"  target="_blank">Online Application Form</a>,
        "In the Online Application above, please print the Visa Requirements (available in Castellano & English) and enter your e-mail address to proceed.",
      ],
    },
  },
...
const datatable1 = [
  ["Single","$90.00", "More than 10 Business Days", "Up to 30 days", "	3 Months"],
];

const datatable2 = [
  ["$90.00", "More than 10 Business Days"],
...
function Business_Us_Visa_Bolivia() {
  return (
    <div>
      <div>
...
export default Business_Us_Visa_Bolivia;