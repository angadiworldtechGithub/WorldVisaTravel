...
import MozambiqueVisa from "../../../legalizationpdf/MozambiqueVisa.pdf"
  ...
  const tableData = [
...

    {
      ...
      column2: {
        content: [
          <a download={true} target='_blank' href={MozambiqueVisa}>Download Visa Application.</a>,
...
const datatable1 = [
    ...
    ['Rush','Single/Multiple', '$225.00/$255.00', '2-4 Business Days' ,'Up to 30 days', '2 Months/3 Months'],
