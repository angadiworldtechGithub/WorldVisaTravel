...
import BrazilWhiteGlove from "../../../legalizationpdf/BrazilWhiteGlove.pdf"
  ...
  const tableData = [
...

    {
      ...
      column2: {
        content: [
<a download={true} target='_blank' href={"https://formulario-mre.serpro.gov.br/sci/pages/web/ui/#/cidadao-nacionalidade"}>Download Application form</a>,
...
<a download={true} target='_blank' href={BrazilWhiteGlove}>Brazil White Glove Application Form</a>,        ],
      },
    },
...
const datatable1 = [
  ['Single/Multiple', '$165.00', '3-10 Business Days' ,'Up to 90 days', 'Up to 10 Years'],
...
function Brazil() {
  return (
   ...
   <div>
    ...
    <div className="req-table-container">
    <center><h3 className='costing-Header'>CONSULAR FEES(REGULAR/RUSH)</h3></center>
     ...
     <div className='Detailsdata_descripition'>
       <h6>Jurisdiction: District of Columbia (DC), North Carolina (NC), Delaware (DE), Kentucky (KY), Maryland (MD), Ohio (OH), Virginia (VA), West Virginia (WV) and all Military Bases, except Guam.</h6>
      ...
      <div className='Detailsdata_descripition'>
       <h6>Please contact our offices for any questions.</h6>
