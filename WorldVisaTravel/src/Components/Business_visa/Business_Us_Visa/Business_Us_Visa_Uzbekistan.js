...
import pdf from "../../../legalizationpdf/WVT-Work-Order.pdf"
  ...
  const tableData = [
    ...
    {
        id: 4,
        column1: "Confirmation		",
        column2: {
          content: [
            "Business Multiple or Single Entry Visas are issued only upon confirmation received by the Embassy, from the Ministry of Foreign Affairs of Uzbekistan.            ",
"Formal written request for issuance of visa must be submitted by the inviting organization in Uzbekistan (Government office, Embassy or representative office, etc.) to the Consular Department of the Ministry of Foreign Affairs of Uzbekistan (Address: 9 Uzbekistan Street, Tashkent, 700029)."          
        ],
        },
      },
...

    {
      ...
      column2: {
        content: [
          <a target='_blank' href="https://visa.mfa.uz/ ">Online Application Form</a>,
          "One completed Visa Application, MUST be typed, printed and signed.          ",
...
const datatable1 = [
    ['Regular/Rush','Single/Multiple', '$165.00/ $245.00', '7-10/4-5 Business Days	' ,'	Up to 30 days', '-    '],
