...
import TajikistanVisa from "../../../legalizationpdf/TajikistanVisa.pdf"
  ...
  const tableData = [
...

    {
        ...
        column2: {
          content: [
            "Visa Support Letter from Tajikistan confirmed by the Ministry of Foreign Affairs.            ",          
          ],
        },
      },
...
const datatable1 = [
    ['Regular/Rush','Single', '$$85.00/ $95.00/ $105.00/ $135.00/ $225.00', '2-7 Business Days		' ,'	Up to 14/30/60/90/365 days', '3 Months/3 Months/3 Months/3 Months/1 Year  '],
    ['Regular/Rush','Multiple', '$125.00/$135.00/$165.00/$265.00', '2-7 Business Days		' ,'	Up to 30/60/90/365 days', '3 Months/3 Months/3 Months/1 Year  '],
