...
<a href='https://travel.state.gov/content/travel/en/passports/how-apply/photos.html' target="_blank" >Quality Requirements for Passport Book & Passport Card Photographs</a>
...

    {
        ...
        column2: {
          content: [
            "A letter of invitation from host organization in Ethiopia.",
          ],
        },
      },
      ...
      {
        id: 5,
        column1: "Visa Pre-Approval",
        column2: {
          content: [
            "Pre-Approval Notice from Ethiopia must be sent to the Ethiopian Embassy in Washington DC.",
            "Copy of Visa Pre-Approval must be included with the application."
          ],
        },
      },
...
const datatable1 = [
  ['Regular/Rush','Single/Multiple', '$75.00', '4-8 Business Days' ,'Up to 24 Months', 'Up to 2 Years'],


];

const datatable2 = [
  ['Regular','$90.00','7-8 Business Days'],
  ['Rush','$140.00','4-6 Business Days'],
