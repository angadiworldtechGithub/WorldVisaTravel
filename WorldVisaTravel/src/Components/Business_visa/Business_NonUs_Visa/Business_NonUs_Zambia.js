...
import ZambiaVisa from "../../../legalizationpdf/ZambiaVisa.pdf"
  ...
  const tableData = [
...

    {
      ...
      column2: {
        content: [
          <a download={true} target='_blank' href={ZambiaVisa}>Download Application Form</a>,
...
const datatable1 = [
    ...
    ['Rush','Single/ Double/ Multiple','$145.00/ $175.00/ $175.00','1-2 Business Days		','	Up to 90 days	','	3 Years'],
...
const datatable2 = [
  ...
  ['Multiple', '$190.00', 'Same Day/Next Day  ' ],
