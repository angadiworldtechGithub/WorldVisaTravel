...
import EcuadorVisa from "../../../legalizationpdf/EcuadorVisa.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={EcuadorVisa}>Download Application Form</a>,
...
export default BusinessNonUsEcuador;
