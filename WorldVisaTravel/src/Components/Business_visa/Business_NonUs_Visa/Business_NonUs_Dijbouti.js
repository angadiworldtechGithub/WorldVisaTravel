...
import DjiboutiVisa from "../../../legalizationpdf/DjiboutiVisa.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: [
          <a download={true} target='_blank' href={DjiboutiVisa}>Download Application Form</a>,
...
const datatable1 = [
  ["Regular/Rush","Single/Multiple","$65.00/$95.00/$125.00", "1-4 Business Days", "Up to 30/90/180 days", "	30/90/180 Days"]
];

const datatable2 = [
  ["Regular","$90.00", "4 Business Days"],
  ["Rush","$140.00", "1-3 Business Days"],
...
function BusinessNonUsDijbouti() {
  return (
    <div>
      <div>
...
export default BusinessNonUsDijbouti;
