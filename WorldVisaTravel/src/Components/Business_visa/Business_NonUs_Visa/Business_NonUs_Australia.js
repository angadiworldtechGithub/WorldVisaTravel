...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={AustraliaETA}>Download Application Form</a>,
...
const datatable1 = [
  ["Multiple", "Determined by Nationalities", "-", "Determined by Nationalities", "Determined by Nationalities"],
];
...
function BusinessNonUsAustralia() {
  return (
    <div>
      <div>
...
export default BusinessNonUsAustralia;
