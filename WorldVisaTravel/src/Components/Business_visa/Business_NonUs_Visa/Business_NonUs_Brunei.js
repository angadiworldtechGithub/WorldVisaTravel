...
import BruneiVisa from "../../../legalizationpdf/BruneiVisa.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: ["	A letter stating the reason for the visit."],
    },
  },
  {
    id: 6,
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={BruneiVisa}>Download Application Form</a>,
...
const datatable1 = [
  ["Single","$19.00", "7 Business Days", "	1-30 days", "	3 Months"],
];

const datatable2 = [
  ["$90.00", "7 Business Days"],
...
export default BusinessNonUsBrunei;
