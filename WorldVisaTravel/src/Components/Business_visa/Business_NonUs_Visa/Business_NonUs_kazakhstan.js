...
const datatable1 = [
  ["Regular/Rush","Single/Double/Multiple","$165.00", "5-8 Business Days", "Up to 30 days", "3 Months"],
];
...
function BusinessNonUsKazakhstan() {
  return (
    <div>
      <div>
...
export default BusinessNonUsKazakhstan;
