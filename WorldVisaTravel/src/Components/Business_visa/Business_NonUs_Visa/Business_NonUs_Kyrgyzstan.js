...
import KyrgyzstanVisa from "../../../legalizationpdf/KyrgyzstanVisa.pdf";
const tableData = [
  {
    id: 1,
    column1: "Passport",
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={KyrgyzstanVisa}>Download Application Form</a>,
...
const datatable1 = [
  ["Regular/Rush","Single","$115.00/$225.00", "10-12/3-4 Business Days", "Up to 30 days", "1 Month"],
  ["Regular/Rush","Double","$125.00/$245.00", "10-12/3-4 Business Days", "Up to 30 days", "1 Month"],
  ["Regular/Rush","Single","$125.00/$245.00", "10-12/3-4 Business Days", "Up to 3 Months", "3 Months"],
  ["Regular/Rush","Single","$145.00/$285.00", "10-12/3-4 Business Days", "Up to 30 days", "3 Months"],
  ["Regular/Rush","Double","$185.00/$365.00", "10-12/3-4 Business Days", "Up to 30 days", "6 Months"],
  ["Regular/Rush","Multiple","$245.00/$485.00", "10-12/3-4 Business Days", "Up to 30 days", "1 Year"],
]

const datatable2 = [
  ["Regular","$90.00", "10-12 Business Days"],
...
function BusinessNonUsKyrgyzstan() {
  return (
    <div>
      <div>
...
export default BusinessNonUsKyrgyzstan;
