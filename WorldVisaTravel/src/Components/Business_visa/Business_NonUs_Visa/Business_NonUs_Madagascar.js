...
import MadagascarVisa from "../../../legalizationpdf/MadagascarVisa.pdf";
...
const tableData = [
    ...
    },
    {
      ...
      column2: {
        content: [
          <a download={true} target='_blank' href={MadagascarVisa}>Download Application Form</a>,
...
const datatable1 = [
  ["Single/Double/Triple","$63.20", "4 Business Days", "Up to 30 days/60 days/90 days", "6 Months"],
];
...
function BusinessNonUsMadagascar() {
  return (
    <div>
      <div>
...
export default BusinessNonUsMadagascar;
