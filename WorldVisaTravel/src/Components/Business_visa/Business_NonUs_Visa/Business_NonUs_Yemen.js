...
import YemenVisa from "../../../legalizationpdf/YemenVisa.pdf"
  ...
  const tableData = [
    ...
    
    {
      ...
      {
        id: 6,
        column1: "Doctor’s Letter	",
        column2: {
          content: [
            "A letter from a doctor confirming the absence of any contagious diseases.            ",
          ],
        },
      },  
...

    {
      ...
      column2: {
        content: [
          <a download={true} target='_blank' href={YemenVisa}>Download Application Form</a>,
...
const datatable1 = [
    ['Regular','	Single/Multiple','$40.00/ $70.00','7-10 Business Days	','Up to 30 days	','	3  Months / 6 Months'],
    ['Regular','Single/Multiple','$70.00/ $100.00','4-5 Business Days		','	Up to 30 days	','	3 Months / 6 Months  '],
