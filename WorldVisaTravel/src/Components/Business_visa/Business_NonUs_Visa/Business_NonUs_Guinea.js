...
import GuineaVisa from "../../../legalizationpdf/GuineaVisa.pdf";
import Guinea_White_Glove_Visa_Form from "../../../legalizationpdf/Guinea_White_Glove_Visa_Form.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={GuineaVisa}>Download Application Form</a>,
        "Two completed Visa Application, MUST be signed.",
        "WVT can help you complete the Guinea Visa Online Application through our White Glove Service.",
       "Please call for further assistance.",
       <a download={true} target='_blank' href={Guinea_White_Glove_Visa_Form}>Guinea White Glove Form</a>,
       ],
    },
  },
...
const datatable1 = [
  ["Regular","Multiple","$165.00", "3-4 Business Days", "Up to 30 days", "	Up to 3 Years"],
];

const datatable2 = [
  ["Regular","$120.00", "3-4 Business Days"],
...
export default BusinessNonUsGuinea;
