...
const tableData = [
  ...
  {
    id: 4,
    column1: "Sri Lanka ETA Visa Questionnaire",
    column2: {
  ...
  {
    id: 6,
    column1: "Note: Visa Validity and Arrival Procedure",
    column2: {
      content: [
        "Please Note:",
        "Kuwait eVisas are valid for a single entry only.",
        "You must enter Kuwait within 30 days after the visa is issued. Please do not apply for your eVisa more than one month in advance of your trip.",
        "You will be required to pay a visa fee of 3 Kuwaiti Dinar (approximately $10 US) when you arrive in Kuwait.",
    ],
    },
  },
  {
...
const datatable1 = [
  ["Double","$62.00","2  Business Days","30 Days","90 Days Valid"],
];
...
function E_NonUs_Businessvisa_Srilanka() {
  return (
    <div>
      <div>
...
export default E_NonUs_Businessvisa_Srilanka;
