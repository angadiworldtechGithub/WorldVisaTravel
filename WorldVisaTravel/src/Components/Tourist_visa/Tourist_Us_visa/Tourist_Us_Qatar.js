...
import QatarVisa from "../../../legalizationpdf/QatarVisa.pdf"
  ...
  const tableData = [
    ...
    },
    {
    ...
    }, 
     {
...

      {
        ...
        column2: {
          content: [
        "A letter of invitation from host in Qatar."
        ],
        },
      },
      {
...

    {
        ...
        column2: {
          content: [
            <a download={true} target='_blank' href={QatarVisa}>Online Application Form</a>,
...
export default Tourist_Us_Qatar;