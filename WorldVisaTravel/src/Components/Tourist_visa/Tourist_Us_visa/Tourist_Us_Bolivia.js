      ...
      },
      {
        ...
        column2: {
          content: [
            ...
            "In the Online Application above, please print the Visa Requirements (available in Castellano & English) and",
            "enter your e-mail address to proceed.",
          ],
        },
      },
...
const datatable1 = [
  ['Regular/Rush','Single','$165.00','2-7 Business Days','Up to 30 day/visit','5 Years'],
];

const datatable2 = [
  ['Regular','$90.00','5-7 Business Days'],
  ['Rush','$125.00','2-5 Business Days'],
];
...
export default Tourist_Us_Bolivia;