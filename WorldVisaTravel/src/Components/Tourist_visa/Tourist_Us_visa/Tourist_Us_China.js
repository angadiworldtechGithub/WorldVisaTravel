...
import China_Legalization from "../../../legalizationpdf/China_Legalization.pdf"
import ChinaVisa from "../../../legalizationpdf/ChinaVisa.pdf"
  const tableData = [
    {
      id: 1,
      column1: "Passport",
    ...
    {
        id: 3,
        column1: "Proof of Employment",
        column2: {
          content: [
             "A letter of employment from employer as a proof, including details of position and job duties of the applicant."
          ],
        },
      },
...

    {
        ...
        column2: {
          content: [
        "A letter from the organization stating details of travelers and agreement to not perform any religious activities.",
          ],
        },
      },
      {
      ...
      {
        id: 7,
        column1: "Former Chinese Citizens",
        column2: {
          content: [
        ...
        column2: {
          content: [
            <a download={true} target='_blank' href={ChinaVisa}>Download here</a>,
            "One completed Visa Application, MUST be typed and signed. If questions not applicable, type N/A.",
            "**UPDATE as of February 2023, Visa applicants need to log on to the website",
            <a download={true} target='_blank' href={China_Legalization}>China Online Visa Application (COVA)</a>,
            "to fill in the online visa application, and make appointments for on-site submission at the Visa Office by the website.“Appointment for Visa Application Submission (AVAS)”",
            "Please contact us for further assistance.",
            <a href="https://cova.mfa.gov.cn/qzCoCommonController.do?show&pageId=index&locale=en_US">"China Online Visa Application (COVA)",</a>,
            <a href="https://avas.mfa.gov.cn/qzyyCoCommonController.do?yyindex&locale=en_US">"Appointment for Visa Application Submission (AVAS)",</a>,
          ],
        },
      },
    {
...
const datatable1 = [
  ['Regular','Single/Double/Multiple','$190.00','5-7 Business Days','Up to 30-90 days','3 Months - 10 years'],
  ['Rush','Single/Double/Multiple','$215.00','3-4 Business Days','Up to 30-90 days','3 Months - 10 years'],
];
...
export default Tourist_Us_China;