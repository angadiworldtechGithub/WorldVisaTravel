  ...
  const tableData = [
    ...
    },
    {
    ...
    
      {
        ...
        column2: {
          content: [
            <a download={true} target='_blank' href={GhanaRegularVisa}>Download  RegularVisa Application</a>,
               "One completed Visa Application, MUST be signed.",
          <a download={true} target='_blank' href={GhanaAppsRush}>Download  RushVisa Application</a>,
...
const datatable1 = [
['Regular','Single/Multiple','$65.00','15-20 Business Days','up to 30 days','3 months/1-3 years'],
...
export default Tourist_Us_Ghana;