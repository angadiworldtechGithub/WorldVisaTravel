...
import UAEVisa from "../../../legalizationpdf/UAEVisa.pdf"
  ...
  const tableData = [
   ...
   
    {
        ...
        column2: {
          content: [
            <a download={true} target='_blank' href={UAEVisa}>Uganda East Africa Visa Application</a>,
            " Please check “EAC” for East Africa Visa.",
...
const datatable1 = [
['Regular/Rush','Multiple','$105.00/$135.00','2-5 Business Days','Up to 90 Days','3 Months']
...
export default Tourist_Us_Uganda;