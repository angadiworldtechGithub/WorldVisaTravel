  ...
  const tableData = [
    ...
    }, 
    {
      ...
      },
      {
        ...
        column2: {
          content: [
           "A letter of invitation from host in Pakistan."
...

    {
        ...
        column2: {
          content: [
          <a download={true} target='_blank' href={PakistanVisa}>Online Application Form</a>,
...
const datatable1 = [
['Single/Multiple','$197.00','More than 4 weeks','Up to 30 days','3 Months']
...
export default Tourist_Us_Pakistan;