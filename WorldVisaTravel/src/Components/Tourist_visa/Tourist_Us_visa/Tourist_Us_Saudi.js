...
import SaudiInvitationSample from "../../../legalizationpdf/SaudiInvitationSample.pdf"
import SaudiVisa1 from "../../../legalizationpdf/SaudiVisa1.pdf"
import SaudiEnjaz from "../../../legalizationpdf/SaudiEnjaz.pdf"
import SaudiDeclaration from "../../../legalizationpdf/SaudiDeclaration.pdf"
  ...
  const tableData = [
    ...
    },
    {
    ...
    }, 
     {
      ...
      {
        id: 4,
        column1: "Invitation Approval",
        column2: {
          content: [
            "Your sponsor in Saudi Arabia must arrange an invitation approved by the Saudi Arabia Ministry of Foreign Affairs.",
            "The approval should be telexed to the Saudi Embassy in Washington DC.",
            <a download={true} target='_blank' href={SaudiInvitationSample}>Invitation Approval Sample</a>,
            "One copy must be sent to applicant to be submitted together with the Visa Application.",
            "When your approval has been issued, it will state Single or Multiple Entries. Your visa will be issued to match the approval.",
            "If Multiple Entries are required, the approval must request a Multiple Entry Visa."
            ],
        },
      },
      {
...

    {
        ...
        column2: {
          content: [
            <a download={true} target='_blank' href={SaudiVisa1}>Download Application Form</a>,
           
            "One completed Visa Application, MUST be signed.",
            <a download={true} target='_blank' href={SaudiEnjaz}>Download Application Form</a>,
            "One completed Declaration Form, MUST be signed.",
            <a download={true} target='_blank' href={SaudiDeclaration}>Download Saudi Enjaz Questionnaire</a>,
            "One completed Enjaz Questionnaire Form.",
        ],
        },
      },
    {
...
const datatable1 = [
['Regular/Rush','Single/Multiple','$158.50','1-3/ 4-5 Business Days ','Up to 30-90 days','3 Months-5 Years']

];

const datatable2 = [
     ['Regular','$110.00','4-5 Business Days'],
     ['Rush','$170.00','1-3 Business Days'],
...
export default Tourist_Us_Saudi;