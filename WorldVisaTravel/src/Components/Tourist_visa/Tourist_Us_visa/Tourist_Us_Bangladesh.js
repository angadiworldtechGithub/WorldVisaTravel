...
import Bangladesh_Application_Printable from "../../../legalizationpdf/Bangladesh_Application_Printable.pdf"
  ...
  const tableData = [
...

    {
      ...
      column2: {
        content: [
          <a href="https://www.visa.gov.bd/">Download Visa Application</a>,
...
const datatable1 = [
  ['Regular','Single/Multiple','$165.00','10-12 Business Days','Up to 30-90 days','6 Months – 5 Years'],
];
...
function Tourist_Us_Bangladesh() {
  return (
   <div>
   <div>
...
export default Tourist_Us_Bangladesh;