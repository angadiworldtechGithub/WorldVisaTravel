...
const datatable1 = [
  ['Regular','Multiple','$145.00','3-4 Business Days','Up to 90 days','5 Years'],
  ['Rush','Multiple','$195.00','1-2 Business Days','Up to 90 days','5 Years'],
];
...
export default Tourist_Us_Burkina;