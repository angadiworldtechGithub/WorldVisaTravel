...
import SouthSudanVisa from "../../../legalizationpdf/SouthSudanVisa.pdf"
  ...
  const tableData = [
    ...
    }, 
    {
        ...
        column2: {
          content: [
       "A letter of invitation from host in South Sudan."
        ],
        },
      },
      {
...
const datatable1 = [
['US Citizens','Single','$165.00','5 - 10 Business Days ','Up to 30 days','-'],
['Former South Sudanese Nationalities','Single','$50.00','5 - 10 Business Days ','Up to 30 days','-']
...
function Tourist_Us_Southsudan() {
  return (
   <div>
   <div>
...
export default Tourist_Us_Southsudan;