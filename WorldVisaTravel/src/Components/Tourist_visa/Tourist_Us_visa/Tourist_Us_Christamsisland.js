...
import AustraliaETA from "../../../legalizationpdf/AustraliaETA.pdf"
  ...
  const tableData = [
    {
      ...
      column2: {
        content:
         ["U.S. Passport – have to be valid at least 6 months beyond intended stay and must have at least two blank visa pages.For Additional Visa Pages and U.S. Passport Renewal."],
      },
    },
    {
      id: 2,
...

    {
      ...
      column2: {
        content: [
          <a download={true} target='_blank' href={AustraliaETA} >Download Questionnaire Form</a>,
          "One completed Questionnaire Form.",
        ],
      },
    },
...
const datatable1 = [
  ['Multiple','$125.00','–','Up to 90 days per Entry','1 Year'],

];

const datatable2 = [
  ['Regular','$40.00','2-3 Business Days'],
  ['Rush','$90.00','24 Hours'],
];
...
function Tourist_Us_Christamsisland() {
  return (
   <div>
   <div>
...
export default Tourist_Us_Christamsisland;