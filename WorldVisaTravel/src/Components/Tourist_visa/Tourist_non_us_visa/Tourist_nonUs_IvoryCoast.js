...
const tableData = [
...

    {
        ...
        column2: {
            content: [
                "A letter of invitation from host in Cote d’Ivoire.",
            ],
        },
    },
...
const datatable1 = [
    ['Regular/ Rush','Multiple', '$155.00', '2-5 Business Days', 'Up to 90 days', '1 Year'],
...
function Tourist_nonUs_IvoryCoast() {
    return (
        <div>
            <div>
...
export default Tourist_nonUs_IvoryCoast;