...
const tableData = [
...

    {
        ...
        column2: {
            content: [
                "A letter of invitation from a Ukrainian tourist agency or from a Ukrainian hotel.",
            ],
        },
    },
    ...
    {
        id: 5,
        column1: "Private Visit Purpose",
        column2: {
            content: [
                "Original invitation issued in the name of the applicant from a local Immigration Authorities of the Ministry of Interior of Ukraine.",
            ],
        },
    },
...

    {
        ...
        column2: {
            content: [
                <a  target='_blank' href={"https://visa.mfa.gov.ua/visa/index"}>Online Application Form</a>,
...
const datatable1 = [
    ['Regular', 'Single/ Double', '$90.00/ $120.00', 'Up to 30 Business Days', '3 Months'],
    ['Rush', 'Single/ Double', '$175.00/ $235.00', 'Up to 15 Business Days', '3 Months'],

]
const datatable2 = [
    ['Regular', '$80.00', 'Up to 30 Business Days'],
    ['Rush', '$115.00', 'Up to 15 Business Days'],
...
function Tourist_nonUs_Ukraine() {
    return (
        <div>
            <div>
...
export default Tourist_nonUs_Ukraine;