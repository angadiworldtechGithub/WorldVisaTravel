...
import Peru_new_visa_application_form from "../../../legalizationpdf/Peru_new_visa_application_form.pdf";
...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={Peru_new_visa_application_form}>Download Application Form</a>,
        "Two completed Visa Applications, MUST be signed.",
    "Note: Please include Signature, Thumb Print and Photo in Section 3 on each form."],
    },
  },
...
const datatable1 = [
    ["Single","$35.00", "4-5 Business Days", "Up to 90 days","3 Months"],
    
  ];

const datatable2 = [
  ["$90.00", "4-5 Business Days"],
...
export default Tourist_nonUs_Peru;