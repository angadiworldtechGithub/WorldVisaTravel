...
const datatable1 = [
  ['Single', '$55.00', '3-5 Business Days'],
];

const datatable2 = [
  ['Single', '$255.00', 'More than 10 Business Days'],
];
...
function Tourist_nonUs_Barbados() {
  return (
    <div>
      <div>
      ...
      <div className="req-table-container">
        <center><h3 className='costing-Header'>CONSULAR FEES (MOST NATIONALITIES)</h3></center>
...
export default Tourist_nonUs_Barbados;