...
const tableData = [
...

  {
    ...
    column2: {
      content: [
        "A letter authorizing World Visa Travel to pick up your passport from the Bulgarian Embassy.",
      ],
    },
  },

  {
    ...
    column2: {
      content: [
        "	A letter of invitation from host organization in Bulgaria.",
      ],
    },
  },
  {
    ...
    column2: {
      content: [
        "A copy of your medical insurance policy with coverage of at least $5,000.00 valid in Bulgaria.",
      ],
    },
  },
  {
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={BulgariaVisa}>Download Application Form</a>,
...
function Tourist_nonUs_Bulgaria() {
  return (
    <div>
      <div>
...
export default Tourist_nonUs_Bulgaria;