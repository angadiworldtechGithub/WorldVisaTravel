...
const datatable1 = [
    [ 'Single/Double', '$65.00/ $80.00', '3 Weeks', 'Up to 90 days', '6 Months'],
...
function Tourist_nonUs_Zimbabwe() {
    return (
        <div>
            <div>
            ...
            <div className="req-table-container">
                ...
                <center><h3 className='costing-Header'>CONSULAR FEES (CANADA, IRELAND, UK NATIONALITIES)
                </h3></center>
                <table className="costing-responsive-table">
                    <thead>
                        <tr>
...
export default Tourist_nonUs_Zimbabwe;