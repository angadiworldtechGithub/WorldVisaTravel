...
import NepalVisaTourist from "../../../legalizationpdf/NepalVisaTourist.pdf";
...
const tableData = [
    ...
    },
    {
        ...
        column2: {
            content: [
                <a download={true} target='_blank' href={NepalVisaTourist}>Download Application Form</a>,
...
const datatable1 = [
    ['Multiple','$35.00/ $55.00/ $130.00', '6-8 Business Days','Up to 15 days/ 30 days/ 90 days', '6 Months'],
...
export default Tourist_nonUs_Nepal;