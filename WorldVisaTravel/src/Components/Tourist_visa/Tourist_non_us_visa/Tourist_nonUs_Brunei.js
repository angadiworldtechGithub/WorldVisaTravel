...
const tableData = [
...

  {
    ...
    column2: {
      content: [
        "A letter stating the reason for the visit.",
      ],
    },
  },
...

  {
    ...
    column2: {
      content: [
        "Download Visa Application", <a download={true} target='_blank' href={BruneiVisa}>Download Visa Application</a>,
...
export default Tourist_nonUs_Brunei;