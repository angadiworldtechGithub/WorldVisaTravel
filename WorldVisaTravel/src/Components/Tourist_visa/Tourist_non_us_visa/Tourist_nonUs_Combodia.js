...
import CambodiaVisa from "../../../legalizationpdf/CambodiaVisa.pdf";
...
const tableData = [
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={CambodiaVisa}>Download Visa Application</a>,
...
const datatable1 = [
  ['Regular/Rush/Next Day', 'Single', '	$45.00/$75.00/$95.00', '	1-14 Business Days', '	Up to 30 days', '3 Months'],

]
const datatable2 = [
  ['Regular', '$90.00', '1-14 Business Days'],
...
function Tourist_nonUs_Combodia() {
  return (
    <div>
      <div>
      ...
      <div className="req-table-container">
        ...
        <div className='Detailsdata_descripition'>
          <h6>Consular fee and processing time apply to: Citizens of Bangladesh, India, Myanmar (Burma), Nepal, Pakistan, Sri Lanka, Thailand – Citizens of the People’s Republic of China (PRC), require the approval of the Department of Immigration of Combodia before the Visas can be issued, and it is recommended that applicants contact this Embassy to establish how long their applications will take to be processed.</h6>
...
export default Tourist_nonUs_Combodia;