...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={DjiboutiVisa}>Download Visa Application</a>,
...

  {
    ...
    column2: {
      content: [
        ...
        <a download={true} target='_blank' href={pdf}>Download here</a>,       "Payment can be processed with a credit card or a company/cashier check or money order.",
      ],
    },
  },
...
const datatable1 = [
  ['Regular/ Rush', 'Single/Multiple', '$65.00/$95.00/25.00', '1-4 Business Days', 'Up to 30/90/180 days', '30/90/180 Days'],
...
function Tourist_nonUs_Djibouti() {
  return (
    <div>
      <div>
...
export default Tourist_nonUs_Djibouti;