...
const tableData = [
...

    {
        ...
        column2: {
            content: [
                "A notarized letter of invitation from host in Turkey.",
            ],
        },
    },
...

    {
        ...
        column2: {
            content: [
                ...
                <a  target='_blank' href={"https://www.konsolosluk.gov.tr"}>Online Application Form</a>,
...
const datatable1 = [
    ['Single/ Multiple', '$63.00/ $198.00', '5-7 Business Days','90 Days', '1 Year'],
...
export default Tourist_nonUs_Turkey;