...
const tableData = [
...

    {
        ...
        column2: {
            content: [
                <a download={true} target='_blank' href={KazakhstanVisa}>Download Visa Application</a>,
...
const datatable1 = [
    ['Regular/ Rush','Multiple', '$165.00', '5-8 Business Days', 'Up to 30 days', '3 Months'],

]
const datatable2 = [
    ['Regular','$90.00', '6-8 Business Days'],
    ['Rush','$140.00', '5 Business Days'],
...
function Tourist_nonUs_Kazakhatan() {
    return (
        <div>
            <div>
...
export default Tourist_nonUs_Kazakhatan;