...
const datatable1 = [
    ['Regular/ Rush','Single/ Multiple','$160.00/ $200.00', 'More than 5-10 Business Days','Up to 30 days', '1 Year'],
   
]
const datatable2 = [
    [ 'Regular','$90.00', 'More than 10 Business Days'],
    [ 'Rush','$140.00', 'More than 5 Business Days'],
];
...
export default Tourist_nonUs_Niger;