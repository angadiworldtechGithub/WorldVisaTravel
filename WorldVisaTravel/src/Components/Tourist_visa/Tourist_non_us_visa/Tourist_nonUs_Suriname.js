...
import SurinameVisa from "../../../legalizationpdf/SurinameVisa.pdf";
  ...
  const tableData = [
...

    {
      ...
      column2: {
        content: [
          <a download={true} target='_blank' href={SurinameVisa}>Download Application Form</a>,
...
const datatable1 = [
  ['Multiple', '$50.00/ $95.00/ $140.00/ $215.00', '4-5 Business Days' ,'Up to 60 days', '2 Months/ 3 Months/ 6 Months/ 1 Year'],
...
function Tourist_nonUs_Suriname() {
  return (
   <div>
   <div>
...
export default Tourist_nonUs_Suriname;