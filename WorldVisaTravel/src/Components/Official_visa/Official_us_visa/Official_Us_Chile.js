...
import ChileVisa1 from "../../../legalizationpdf/ChileVisa1.xls";
import ChileVisa2 from "../../../legalizationpdf/ChileVisa2.xls";
const tableData = [
  {
    id: 1,
    column1: "Passport",
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={ChileVisa1}>Download Application Form 1</a>,"",
        <a download={true} target='_blank' href={ChileVisa2}>Download Application Form 2</a>,
        "One each completed Visa Application, MUST be signed.",
      ],
    },
  },
...
const datatable1 = [
  ["Single/Multiple", "$0", "4-5 Business Days", "Up to 30 days", "3 Months"],
];
...
export default OfficialUsChile;
