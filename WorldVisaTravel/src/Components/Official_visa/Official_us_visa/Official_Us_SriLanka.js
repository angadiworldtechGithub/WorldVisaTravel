...
import SriLankaODVisa from "../../../legalizationpdf/SriLankaODVisa.pdf";
const tableData = [
  {
    id: 1,
    column1: "Passport",
...

  {
    ...
    column2: {
      content: [
        <a download={true} target='_blank' href={SriLankaODVisa}>Download Application Form</a>,
...
export default OfficialUsSriLanka;
