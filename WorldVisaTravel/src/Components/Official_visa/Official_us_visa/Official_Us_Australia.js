...
import AustraliaDiplomatVisa from "../../../legalizationpdf/AustraliaDiplomatVisa.pdf";
import AustraliaForm956A from "../../../legalizationpdf/AustraliaForm956A.pdf";
import AustraliaForm1190 from "../../../legalizationpdf/AustraliaForm1190.pdf";
  ...
  const tableData = [
    {
      ...
      column1: "Passport",
      column2: {
        content: ["	U.S. Official/Diplomatic Passport – have to be valid at least 6 months beyond intended stay and must have at least two blank visa pages. ", <p> <a href="/visas">Additional Visa Pages</a> and <a href="/passports/renew">U.S. Passport Renewal</a> </p>],
      },
    },
    {
      id: 2,
    ...
    
    {
      ...
      column2: {
        content: [
          <a download={true} target='_blank' href={AustraliaDiplomatVisa}>Download Application Form</a>,
          "One completed Visa Application, MUST be signed",
          <a download={true} target='_blank' href={AustraliaForm956A}>Download Authorization Form 956A</a>,
          "One completed Authorization Form.",
          <a download={true} target='_blank' href={AustraliaForm1190}>Download Form 1190 for Additional Character</a>,
...
const datatable1 = [
  ['$0', '3-4 Weeks' ,'Up to 90 days', '3 Months']
...
export default OfficialUsAustralia;