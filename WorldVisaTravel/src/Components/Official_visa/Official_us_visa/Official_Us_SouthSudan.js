...
const tableData = [
  ...
  },
  {
    ...
    column2: {
      content: ["An official letter of invitation from hosting government organization."],
    },
  },
  {
    id: 5,
...
const datatable1 = [
  ["Single/Multiple", "$0", "5-7 Business Days", "-", "-"],
];
...
export default OfficialUsSouthSudan;
